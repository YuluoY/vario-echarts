export default {
  "__EC_DOC_option_grid": {
    ...
    "left": {
      "desc": "<p>Distance between undefined component and the left side of the container.</p>\n<p><code class=\"codespan\">left</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container width like <code class=\"codespan\">&#39;20%&#39;</code>; and it can also be <code class=\"codespan\">&#39;left&#39;</code>, <code class=\"codespan\">&#39;center&#39;</code>, or <code class=\"codespan\">&#39;right&#39;</code>.</p>\n<p>If the <code class=\"codespan\">left</code> value is set to be <code class=\"codespan\">&#39;left&#39;</code>, <code class=\"codespan\">&#39;center&#39;</code>, or <code class=\"codespan\">&#39;right&#39;</code>, then the component will be aligned automatically based on position.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "top": {
      "desc": "<p>Distance between undefined component and the top side of the container.</p>\n<p><code class=\"codespan\">top</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container height like <code class=\"codespan\">&#39;20%&#39;</code>; and it can also be <code class=\"codespan\">&#39;top&#39;</code>, <code class=\"codespan\">&#39;middle&#39;</code>, or <code class=\"codespan\">&#39;bottom&#39;</code>.</p>\n<p>If the <code class=\"codespan\">top</code> value is set to be <code class=\"codespan\">&#39;top&#39;</code>, <code class=\"codespan\">&#39;middle&#39;</code>, or <code class=\"codespan\">&#39;bottom&#39;</code>, then the component will be aligned automatically based on position.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "right": {
      "desc": "<p>Distance between undefined component and the right side of the container.</p>\n<p><code class=\"codespan\">right</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container width like <code class=\"codespan\">&#39;20%&#39;</code>.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "bottom": {
      "desc": "<p>Distance between undefined component and the bottom side of the container.</p>\n<p><code class=\"codespan\">bottom</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container height like <code class=\"codespan\">&#39;20%&#39;</code>.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "width": {
      "desc": "<p>Width of grid component. Adaptive by default.</p>\n<p><code class=\"codespan\">width</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container width like <code class=\"codespan\">&#39;20%&#39;</code>.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "50%"
      }
    ...
    "height": {
      "desc": "<p>Height of grid component. Adaptive by default.</p>\n<p><code class=\"codespan\">height</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container height like <code class=\"codespan\">&#39;20%&#39;</code>.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "50%"
      }
    ...
    "outerBoundsMode": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n<p>The &quot;outer bounds&quot; is a constraint rectangle used to prevent axis labels and axis names from overflowing. <code class=\"codespan\">outerBoundsMode</code> defines the strategy for determining the &quot;outer bounds&quot;.</p>\n<p>In most cases, we do not need to specify <a href=\"#grid.outerBoundsMode\">grid.outerBoundsMode</a>, <a href=\"#grid.outerBounds\">grid.outerBounds</a>, <a href=\"#grid.outerBoundsContain\">grid.outerBoundsContain</a> and <a href=\"#grid.containLabel\">grid.containLabel</a>, as the default settings can prevent axis labels and axis names from overflowing the canvas.</p>\n<p>The grid component (Cartesian) layout strategy:</p>\n<ul>\n<li>First, lay out axis lines based on the rect defined by <a href=\"#grid.left\">grid.left</a>/<a href=\"#grid.right\">right</a>/<a href=\"#grid.top\">top</a>/<a href=\"#grid.bottom\">bottom</a>/<a href=\"#grid.width\">width</a>/<a href=\"#grid.height\">height</a>. This can meet the requirement of aligning axis lines across multiple grids.</li>\n<li>Then, if axis labels and/or axis names overflow the &quot;outer bounds&quot;, shrink the rectangle to prevent that overflow. <a href=\"#grid.outerBoundsContain\">grid.outerBoundsContain</a> determines whether axis label and axis name is confined by the &quot;outer bounds&quot;.</li>\n</ul>\n<p>Options of <code class=\"codespan\">outerBoundsMode</code>:</p>\n<ul>\n<li><code class=\"codespan\">&#39;auto&#39;</code>/<code class=\"codespan\">null</code>/<code class=\"codespan\">undefined</code> (default):<ul>\n<li>Behave the same as <code class=\"codespan\">outerBoundsMode: &#39;same&#39;</code> when <code class=\"codespan\">grid.containLabel: true</code>.</li>\n<li>Otherwise, the &quot;outer bounds&quot; is determined by <a href=\"#grid.outerBounds\">grid.outerBounds</a> if specified.</li>\n<li>Otherwise, automatically determine the &quot;outer bounds&quot; - typically defaulting to the current canvas, or a assigned layout rectangle if this <code class=\"codespan\">grid</code> is laid out in another coordinate system (see <a href=\"#grid.coordinateSystem\">grid.coordinateSystem</a>).</li>\n</ul>\n</li>\n<li><code class=\"codespan\">&#39;none&#39;</code>: Force the &quot;outer bounds&quot; to be infinity (i.e., no constraint), regardless of the specified <a href=\"#grid.outerBounds\">grid.outerBounds</a>.</li>\n<li><code class=\"codespan\">&#39;same&#39;</code>: Force the &quot;outer bounds&quot; to be the same as the layout rectangle defined by <a href=\"#grid.left\">grid.left</a>/<a href=\"#grid.right\">right</a>/<a href=\"#grid.top\">top</a>/<a href=\"#grid.bottom\">bottom</a>/<a href=\"#grid.width\">width</a>/<a href=\"#grid.height\">height</a>, regardless of the specified <a href=\"#grid.outerBounds\">grid.outerBounds</a>.</li>\n</ul>\n<blockquote>\n<p>The &quot;outer bounds&quot; encompasses the functionality of <a href=\"#grid.containLabel\">grid.containLabel</a>; therefore, <a href=\"#grid.containLabel\">grid.containLabel</a> is deprecated. <code class=\"codespan\">grid.containLabel: true</code> is equivalent to <code class=\"codespan\">grid: {outerBoundsMode: &#39;same&#39;, outerBoundsContain: &#39;axisLabel&#39;}</code>.\nThe effect might be slightly different, but usually indiscernible. You can use the code below to enforce the previous effect, though it&#39;s unnecessary in most cases.</p>\n<pre><code class=\"lang-js\">import {use} from &#39;echarts/core&#39;;\nimport {LegacyGridContainLabel} from &#39;echarts/features&#39;;\nuse([LegacyGridContainLabel]);\n</code></pre>\n</blockquote>\n<p><strong>Demo</strong>: <a href=\"https://echarts.apache.org/examples/en/editor.html?c=doc-example/grid-outerBounds&amp;edit=1&amp;reset=1\" target=\"_blank\">outerBounds example</a>.</p>\n"
    },
    "outerBounds": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n<p>See details in <a href=\"#grid.outerBoundsMode\">grid.outerBoundsMode</a>.</p>\n<p>See also <a href=\"https://echarts.apache.org/examples/en/editor.html?c=doc-example/grid-outerBounds&amp;edit=1&amp;reset=1\" target=\"_blank\">outerBounds example</a>.</p>\n"
    },
    "outerBounds.left": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n\n<p>Distance between <code class=\"codespan\">outerBounds</code> and the left side of the container.</p>\n<p><code class=\"codespan\">left</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container width like <code class=\"codespan\">&#39;20%&#39;</code>; and it can also be <code class=\"codespan\">&#39;left&#39;</code>, <code class=\"codespan\">&#39;center&#39;</code>, or <code class=\"codespan\">&#39;right&#39;</code>.</p>\n<p>If the <code class=\"codespan\">left</code> value is set to be <code class=\"codespan\">&#39;left&#39;</code>, <code class=\"codespan\">&#39;center&#39;</code>, or <code class=\"codespan\">&#39;right&#39;</code>, then the component will be aligned automatically based on position.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "outerBounds.top": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n\n<p>Distance between <code class=\"codespan\">outerBounds</code> and the top side of the container.</p>\n<p><code class=\"codespan\">top</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container height like <code class=\"codespan\">&#39;20%&#39;</code>; and it can also be <code class=\"codespan\">&#39;top&#39;</code>, <code class=\"codespan\">&#39;middle&#39;</code>, or <code class=\"codespan\">&#39;bottom&#39;</code>.</p>\n<p>If the <code class=\"codespan\">top</code> value is set to be <code class=\"codespan\">&#39;top&#39;</code>, <code class=\"codespan\">&#39;middle&#39;</code>, or <code class=\"codespan\">&#39;bottom&#39;</code>, then the component will be aligned automatically based on position.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "outerBounds.right": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n\n<p>Distance between <code class=\"codespan\">outerBounds</code> and the right side of the container.</p>\n<p><code class=\"codespan\">right</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container width like <code class=\"codespan\">&#39;20%&#39;</code>.</p>\n<p>Adaptive by default.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "outerBounds.bottom": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n\n<p>Distance between <code class=\"codespan\">outerBounds</code> and the bottom side of the container.</p>\n<p><code class=\"codespan\">bottom</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container height like <code class=\"codespan\">&#39;20%&#39;</code>.</p>\n<p>Adaptive by default.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "outerBounds.width": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n\n<p>Width of <code class=\"codespan\">outerBounds</code>. Adaptive by default.</p>\n<p><code class=\"codespan\">width</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container width like <code class=\"codespan\">&#39;20%&#39;</code>.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "50%"
      }
    ...
    "outerBounds.height": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n\n<p>Height of <code class=\"codespan\">outerBounds</code>. Adaptive by default.</p>\n<p><code class=\"codespan\">height</code> can be a pixel value like <code class=\"codespan\">20</code>; it can also be a percentage value relative to the container height like <code class=\"codespan\">&#39;20%&#39;</code>.</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "50%"
      }
    ...
    "outerBoundsContain": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n<p>Options:</p>\n<ul>\n<li><code class=\"codespan\">&#39;auto&#39;</code>/<code class=\"codespan\">null</code>/<code class=\"codespan\">undefined</code> (default):<ul>\n<li>Behave the same as <code class=\"codespan\">outerBoundsContain: &#39;axisLabel&#39;</code> if <code class=\"codespan\">containLabel: true</code>.</li>\n<li>Otherwise, behave the same as <code class=\"codespan\">outerBoundsContain: &#39;all&#39;</code>.</li>\n</ul>\n</li>\n<li><code class=\"codespan\">&#39;all&#39;</code>: The &quot;outer bounds&quot; constrain the grid (Cartesian) rectangle (determined by the x-axis and y-axis lines) and axis labels and axis names.</li>\n<li><code class=\"codespan\">&#39;axisLabel&#39;</code>: The &quot;outer bounds&quot; constrain the grid (Cartesian) rectangle (determined by the x-axis and y-axis lines) and axis labels, but exclude axis names.</li>\n</ul>\n<p>For more details, see <a href=\"#grid.outerBoundsMode\">grid.outerBoundsMode</a>.</p>\n<p>See also <a href=\"https://echarts.apache.org/examples/en/editor.html?c=doc-example/grid-outerBounds&amp;edit=1&amp;reset=1\" target=\"_blank\">outerBounds example</a>.</p>\n"
    },
    "backgroundColor": {
