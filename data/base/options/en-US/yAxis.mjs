export default {
  "__EC_DOC_option_yAxis": {
    ...
    "position": {
      "desc": "\n\n<p>the position of y axis.</p>\n<p>options:</p>\n<ul>\n<li><code class=\"codespan\">&#39;left&#39;</code></li>\n<li><code class=\"codespan\">&#39;right&#39;</code></li>\n</ul>\n<p>The first y axis in grid defaults to be the left (<code class=\"codespan\">&#39;left&#39;</code>)  of the grid, and the second y axis is on the other side against the first y axis.\nNotice: Set <code class=\"codespan\">yAxis.axisLine.onZero</code> to <code class=\"codespan\">false</code> to activate this option.</p>\n",
      "uiControl": {
        "type": "enum",
        "options": "left,right",
        "default": "left"
    ...
    "breaks.gap": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n<p>It determines the visual size of the axis break area.</p>\n<ul>\n<li><p>Percentage (string):</p>\n<p>  Specifies the proportion relative to the axis. For example, <code class=\"codespan\">&#39;5%&#39;</code> means that the final size of the axis break area will always be <code class=\"codespan\">&#39;5%&#39;</code> of the axis length. Using a percentage ensures that the pixel size of the axis break area remains stable, and does not change when <a href=\"#yAxis.min\">yAxis.min</a>, <a href=\"#yAxis.max\">yAxis.max</a>, or <a href=\"#dataZoom\">dataZoom</a> are modified. For this reason, using a percentage is recommended in most scenarios.</p>\n</li>\n<li><p>Absolute value:</p>\n<p>  Its unit is the same as <a href=\"#yAxis.breaks.start\">start</a> and <a href=\"#yAxis.breaks.end\">end</a>, referring to a value in the data domain defined by the business data (<code class=\"codespan\">series.data</code>), rather than pixels. It represents mapping (replacing) the <code class=\"codespan\">[start, end]</code> interval with <code class=\"codespan\">[start, start + gap]</code>. Therefore, if set as an absolute value, the pixel size of the axis break area will change when <a href=\"#yAxis.min\">yAxis.min</a>, <a href=\"#yAxis.max\">yAxis.max</a>, or <a href=\"#dataZoom\">dataZoom</a> are modified.</p>\n</li>\n</ul>\n<p><strong>Notice:</strong> Within a <a href=\"#yAxis.breaks\">yAxis.breaks</a> array, <code class=\"codespan\">gap</code> must be specified either entirely in percentages or entirely in absolute values. Mixing the two is not allowed, as it may lead to unexpected results.</p>\n<p>Note: <a href=\"#yAxis.breaks.start\">yAxis.breaks.start</a> and <a href=\"#yAxis.breaks.end\">yAxis.breaks.end</a> are the unique identifiers for each break item. When calling <a href=\"api.html#echartsInstance.setOption\" target=\"_blank\">chart.setOption</a> to modify <a href=\"#yAxis.breaks.gap\">yAxis.breaks.gap</a> or <a href=\"#yAxis.breaks.isExpanded\">yAxis.breaks.isExpanded</a>, <code class=\"codespan\">start</code> and <code class=\"codespan\">end</code> must be specified. Update animations will only occur if <code class=\"codespan\">start</code> and <code class=\"codespan\">end</code> are not modified; no animation will occur if they are changed.</p>\n"
    },
    "breaks.isExpanded": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n<p>Whether this axis break area is expanded, default is <code class=\"codespan\">false</code>.</p>\n<p>Note: <a href=\"#yAxis.breaks.start\">yAxis.breaks.start</a> and <a href=\"#yAxis.breaks.end\">yAxis.breaks.end</a> are the unique identifiers for each break item. When calling <a href=\"api.html#echartsInstance.setOption\" target=\"_blank\">chart.setOption</a> to modify <a href=\"#yAxis.breaks.gap\">yAxis.breaks.gap</a> or <a href=\"#yAxis.breaks.isExpanded\">yAxis.breaks.isExpanded</a>, <code class=\"codespan\">start</code> and <code class=\"codespan\">end</code> must be specified. Update animations will only occur if <code class=\"codespan\">start</code> and <code class=\"codespan\">end</code> are not modified; no animation will occur if they are changed.</p>\n"
    },
    "breakArea": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n<p>Style of the axis break area.</p>\n<p>See also the introduction to the axis break in <a href=\"#yAxisbreaks\">yAxis.breaks</a>.</p>\n"
    },
    "breakArea.show": {
    ...
    "axisLabel.verticalAlignMinLabel": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v5.5.0</code>\n\n</div>\n\n\n\n\n<p>Vertical alignment of the label of the min tick. If set to be <code class=\"codespan\">null</code>, it&#39;s the same with other labels. See <a href=\"#yAxis.axisLabel.verticalAlign\">verticalAlign</a>.</p>\n<p>Options are:</p>\n<ul>\n<li><code class=\"codespan\">&#39;top&#39;</code></li>\n<li><code class=\"codespan\">&#39;middle&#39;</code></li>\n<li><code class=\"codespan\">&#39;bottom&#39;</code></li>\n<li><code class=\"codespan\">null</code> (default)</li>\n</ul>\n"
    },
    "axisLabel.verticalAlignMaxLabel": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v5.5.0</code>\n\n</div>\n\n\n\n\n<p>Vertical alignment of the label of the max tick. If set to be <code class=\"codespan\">null</code>, it&#39;s the same with other labels. See <a href=\"#yAxis.axisLabel.verticalAlign\">verticalAlign</a>.</p>\n<p>Options are:</p>\n<ul>\n<li><code class=\"codespan\">&#39;top&#39;</code></li>\n<li><code class=\"codespan\">&#39;middle&#39;</code></li>\n<li><code class=\"codespan\">&#39;bottom&#39;</code></li>\n<li><code class=\"codespan\">null</code> (default)</li>\n</ul>\n"
    },
    ...
    "tooltip": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v5.6.0</code>\n\n</div>\n\n\n\n\n<p>The tooltip configuration for yAxis, must set <a href=\"#yAxis.triggerEvent\">triggerEvent</a> as <code class=\"codespan\">true</code> and enable global <a href=\"#tooltip\">option.tooltip</a> component.</p>\n"
    },
    "tooltip.show": {
