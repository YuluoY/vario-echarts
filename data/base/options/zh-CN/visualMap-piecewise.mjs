export default {
  ...
  "selectedMode": {
    "desc": "\n\n<p>选择模式，可以是：</p>\n<ul>\n<li><code class=\"codespan\">&#39;multiple&#39;</code>（多选）。</li>\n<li><code class=\"codespan\">&#39;single&#39;</code>（单选）。</li>\n<li><code class=\"codespan\">true</code>（单选）从<code class=\"codespan\">5.3.3</code>版本支持。</li>\n<li><code class=\"codespan\">false</code>（禁止选择）从<code class=\"codespan\">5.3.3</code>版本支持。</li>\n</ul>\n",
    "uiControl": {
      "type": "enum",
  ...
  "textGap": {
    "desc": "\n\n<p>每项的色块与文本标签之间的距离，单位为px。参见 <a href=\"#visualMap-piecewise.showLabel\">visualMap-piecewise.showLabel</a></p>\n",
    "uiControl": {
      "type": "number",
      "default": "10"
    }
