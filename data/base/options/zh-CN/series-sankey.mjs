export default {
  ...
  "zoom": {
    "desc": "\n\n\n<p>当前视角的缩放比例。</p>\n<p>值小于 <code class=\"codespan\">1</code> 时表示缩小，大于 <code class=\"codespan\">1</code> 时表示放大。</p>\n<p>当 <a href=\"#series-sankey.roam\">平移缩放（roam）</a> 时，<a href=\"#series-sankey.center\">center</a> 和 <code class=\"codespan\">zoom</code> 的值会被相应改变。</p>\n",
    "uiControl": {
      "type": "number",
      "default": "1",
      "min": "0",
  ...
  "scaleLimit": {
    "desc": "<p><a href=\"#series-sankey.roam\">缩放</a> 的极限控制，通过 <code class=\"codespan\">min</code> 和 <code class=\"codespan\">max</code> 限制最小和最大的缩放值。</p>\n<p>值小于 <code class=\"codespan\">1</code> 时表示缩小，大于 <code class=\"codespan\">1</code> 时表示放大。</p>\n"
  },
  "scaleLimit.min": {
    "desc": "<p>最小的缩放值</p>\n"
  },
  ...
  "roamTrigger": {
    "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p><a href=\"#series-sankey.roam\">缩放和平移（roam）</a> 可被鼠标触发。</p>\n<p>Options:</p>\n<ul>\n<li><p><code class=\"codespan\">&#39;selfRect&#39;</code>:</p>\n<p>  缩放和平移的触发点只能是图形元素形成的包围盒中。</p>\n</li>\n<li><p><code class=\"codespan\">&#39;global&#39;</code>:</p>\n<p>  缩放和平移的触发点是画布中的任何地方。</p>\n</li>\n</ul>\n"
  },
  "edgeLabel": {
    "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.4.1</code> 开始支持\n\n</div>\n\n\n\n<p>关系边文本标签的样式。</p>\n"
  },
  "edgeLabel.show": {
    "desc": "\n\n<p>是否显示标签。</p>\n",
    "uiControl": {
  ...
  "label.textMargin": {
    "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>标签周围的间距，用于避免标签重叠。单位为像素（px）。</p>\n<p>注意：<code class=\"codespan\">textMargin</code> 是作用在标签的本地包围盒上的，也就是说，如果标签设置了旋转（<code class=\"codespan\">rotate</code>），先在未旋转的标签上应用 <code class=\"codespan\">textMargin</code>，再进行旋转。</p>\n<blockquote>\n<p>名字是 <code class=\"codespan\">textMargin</code>，因历史原因 <code class=\"codespan\">margin</code> 已被它用。</p>\n</blockquote>\n<p>示例：</p>\n<pre><code class=\"lang-ts\">// 设置所有方向的间距为 5，等价于 [5, 5, 5, 5]\ntextMargin: 5\n// 设置上下间距为 5，左右间距为 10\ntextMargin: [5, 10]\n// 分别设置四个方向的间距\ntextMargin: [\n    5,  // 上\n    10, // 右\n    5,  // 下\n    10, // 左\n]\n</code></pre>\n"
  },
  "label.minMargin": {
