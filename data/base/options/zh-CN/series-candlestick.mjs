export default {
  ...
  "markPoint.data.relativeTo": {
    "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>可选值：<code class=\"codespan\">&#39;container&#39;</code> 或 <code class=\"codespan\">&#39;coordinate&#39;</code>。指定 <a href=\"#series-candlestick.markPoint.data.x\">x</a> 和 <a href=\"#series-candlestick.markPoint.data.y\">y</a> 是相对于整个图表容器（<code class=\"codespan\">&#39;container&#39;</code>，默认值）还是直角坐标系（<code class=\"codespan\">&#39;coordinate&#39;</code>）而言的位置。</p>\n"
  },
  ...
  "markPoint.z": {
    "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p><code class=\"codespan\">z</code>值小的图形会被<code class=\"codespan\">z</code>值大的图形覆盖。</p>\n<p><code class=\"codespan\">z</code>相比<code class=\"codespan\">zlevel</code>优先级更低，而且不会创建新的 Canvas。</p>\n"
  },
  "markPoint.animation": {
    "desc": "\n\n<p>是否开启动画。</p>\n",
    "uiControl": {
  ...
  "markLine.symbolOffset": {
    "desc": "<p>标线两端的标记相对于原本位置的偏移，可以是一个数组分别指定两端，也可以是单个统一指定。如果希望单独指定两端标记的水平/垂直偏移，也可以是一个二维数组，每个元素为单个标记的偏移量，例：</p>\n<pre><code class=\"lang-js\">symbolOffset: [\n    [-10, 20],    // 起始标记偏移\n    [&#39;50%&#39;, 100]  // 结束标记偏移\n]\n</code></pre>\n<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.1.0</code> 开始支持\n\n</div>\n\n\n"
  },
  "markLine.precision": {
