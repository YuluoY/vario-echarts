export default {
  ...
  "scaleLimit": {
    "desc": "<p><a href=\"#series-tree.roam\">缩放</a> 的极限控制，通过 <code class=\"codespan\">min</code> 和 <code class=\"codespan\">max</code> 限制最小和最大的缩放值。</p>\n<p>值小于 <code class=\"codespan\">1</code> 时表示缩小，大于 <code class=\"codespan\">1</code> 时表示放大。</p>\n"
  },
  "scaleLimit.min": {
    "desc": "<p>最小的缩放值</p>\n"
  },
