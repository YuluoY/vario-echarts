export default {
  ...
  "polarId": {
    "desc": "<p>布局时所基于的 <a href=\"#polar\">极坐标系</a> 的 id。当一个 ECharts 实例中存在多个极坐标系时，用其指定所使用的坐标系。</p>\n"
  },
  "singleAxisIndex": {
    "desc": "<p>布局时所基于的 <a href=\"#singleAxis\">单轴标系</a> 的 index。当一个 ECharts 实例中存在多个单轴坐标系时，用其指定所使用的坐标系。</p>\n"
  },
  "singleAxisId": {
    "desc": "<p>布局时所基于的 <a href=\"#singleAxis\">单轴标系</a> 的 id。当一个 ECharts 实例中存在多个单轴坐标系时，用其指定所使用的坐标系。</p>\n"
  },
  "geoIndex": {
  ...
  "renderItem.arguments.api.layout": {
    "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>将数据值转换成坐标系上的布局信息。</p>\n<p>其行为、输入参数和返回值和 <a href=\"api.html#echartsInstance.convertToLayout\" target=\"_blank\">chart.convertToLayout</a> 相同（只是去除它的第一个参数 <code class=\"codespan\">finder</code>）。</p>\n"
  },
  ...
  "renderItem.return_sector.shape.cornerRadius": {
    "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.3.0</code> 开始支持\n\n</div>\n\n\n\n<p>扇形的圆角。</p>\n<ul>\n<li><code class=\"codespan\">cornerRadius: 10</code>：表示内圆角半径和外圆角半径都是 <code class=\"codespan\">10px</code>。</li>\n<li><code class=\"codespan\">cornerRadius: [10, 20]</code>：表示为环形图时，内圆角半径是 <code class=\"codespan\">10px</code>、外圆角半径是 <code class=\"codespan\">20px</code>。</li>\n<li><code class=\"codespan\">cornerRadius: [5, 10, 15, 20]</code>：表示内圆角半径分别为 <code class=\"codespan\">5px</code> 和 <code class=\"codespan\">10px</code>，外圆角半径分别为 <code class=\"codespan\">15px</code> 和 <code class=\"codespan\">20px</code>。</li>\n</ul>\n"
  },
  ...
  "renderItem.return_compoundPath.name": {
    "desc": "<p>参见 <a href=\"#series-custom.renderItem.return_compoundPath.diffChildrenByName\">diffChildrenByName</a>。</p>\n"
  },
  ...
  "renderItem.return_compoundPath.shape.paths": {
    "desc": "<p>图形元素的数组，元素可以是 path/rect/circle/……</p>\n"
  },
