{
  "__EC_DOC_option_series_custom": {
    ...
    "coordinateSystem": {
      "desc": "<p>Specifies another coordinate system component on which this <code class=\"codespan\">series-custom</code> is laid out.</p>\n<p>Options:</p>\n<ul>\n<li><p><code class=\"codespan\">null</code>/<code class=\"codespan\">undefined</code>/<code class=\"codespan\">&#39;none&#39;</code></p>\n<p>  Not laid out in any coordinate system; instead, laid out independently.</p>\n</li>\n</ul>\n<ul>\n<li><p><code class=\"codespan\">&#39;cartesian2d&#39;</code></p>\n<p>  Lay out based on a two-dimensional <a href=\"#grid\">rectangular coordinate system (also known as Cartesian coordinate system)</a>. When multiple <code class=\"codespan\">xAxis</code> or multiple <code class=\"codespan\">yAxis</code> exist within an ECharts instance, the corresponding axes should be specified using <a href=\"#series-custom.xAxisIndex\">xAxisIndex</a> and <a href=\"#series-custom.yAxisIndex\">yAxisIndex</a> or <a href=\"#series-custom.xAxisId\">xAxisId</a> and <a href=\"#series-custom.yAxisId\">yAxisId</a>.</p>\n<p>  Note: some commonly used series, such as <a href=\"#series-line\">series-line</a>, <a href=\"#series-bar\">series-bar</a>, etc., can not be laid out directly based on <a href=\"#matrix\">matrix coordinate system</a> or <a href=\"#calendar\">calendar coordinate system</a>, but they can be laid out on a <a href=\"#grid\">grid(Cartesian)</a>, and that <a href=\"#grid\">grid</a> can be laid out on a <a href=\"#matrix\">matrix</a> or <a href=\"#calendar\">calendar</a>.</p>\n</li>\n</ul>\n<ul>\n<li><p><code class=\"codespan\">&#39;polar&#39;</code></p>\n<p>  Lay out based on a <a href=\"#polar\">polar coordinate system</a>. When multiple polar coordinate systems exist within an ECharts instance, the corresponding system should be specified using <a href=\"#series-custom.polarIndex\">polarIndex</a> or <a href=\"#series-custom.polarId\">polarId</a>.</p>\n</li>\n</ul>\n<ul>\n<li><p><code class=\"codespan\">&#39;geo&#39;</code></p>\n<p>  Lay out based on a <a href=\"#geo\">geographic coordinate system</a>. When multiple geographic coordinate systems exist within an ECharts instance, the corresponding system should be specified using <a href=\"#series-custom.geoIndex\">geoIndex</a> or <a href=\"#series-custom.geoId\">geoId</a>.</p>\n</li>\n</ul>\n<ul>\n<li><p><code class=\"codespan\">&#39;singleAxis&#39;</code></p>\n<p>  Lay out based on a <a href=\"#singleAxis\">singleAxis coordinate system</a>. When multiple singleAxis coordinate systems exist within an ECharts instance, the corresponding system should be specified using <a href=\"#series-custom.polarIndex\">singleAxisIndex</a> or <a href=\"#series-custom.polarId\">singleAxisId</a>.</p>\n</li>\n</ul>\n<ul>\n<li><p><code class=\"codespan\">&#39;calendar&#39;</code></p>\n<p>  Lay out based on a <a href=\"#calendar\">calendar coordinate system</a>. When multiple calendar coordinate systems exist within an ECharts instance, the corresponding system should be specified using <a href=\"#series-custom.calendarIndex\">calendarIndex</a> or <a href=\"#series-custom.calendarId\">calendarId</a>.</p>\n</li>\n</ul>\n<ul>\n<li><p><code class=\"codespan\">&#39;matrix&#39;</code></p>\n<p>  Lay out based on a <a href=\"#matrix\">matrix coordinate system</a>. When multiple matrix coordinate systems exist within an ECharts instance, the corresponding system should be specified using <a href=\"#series-custom.matrixIndex\">matrixIndex</a> or <a href=\"#series-custom.matrixId\">matrixId</a>.</p>\n</li>\n</ul>\n<p><strong>Support for series and component layout on coordinate systems:</strong></p>\n<p>The leftmost column lists the series and components that will be laid out (coordinate systems themselves are also components), and the topmost row lists the coordinate systems that can be laid out on.</p>\n<table>\n<thead>\n<tr>\n<th></th>\n<th>no coord sys</th>\n<th><a href=\"#grid\">grid</a> (cartesian2d)</th>\n<th><a href=\"#polar\">polar</a></th>\n<th><a href=\"#geo\">geo</a></th>\n<th><a href=\"#singleAxis\">singleAxis</a></th>\n<th><a href=\"#radar\">radar</a></th>\n<th><a href=\"#parallel\">parallel</a></th>\n<th><a href=\"#calendar\">calendar</a></th>\n<th><a href=\"#matrix\">matrix</a></th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><a href=\"#grid\">grid</a> (cartesian2d)</td>\n<td>✅</td>\n<td>❌</td>\n<td>���</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#polar\">polar</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#geo\">geo</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#singleAxis\">singleAxis</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#calendar\">calendar</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n</tr>\n<tr>\n<td><a href=\"#matrix\">matrix</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n</tr>\n<tr>\n<td><a href=\"#series-line\">series-line</a></td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#grid\">grid</a>)</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#grid\">grid</a>)</td>\n</tr>\n<tr>\n<td><a href=\"#series-bar\">series-bar</a></td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#grid\">grid</a>)</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#grid\">grid</a>)</td>\n</tr>\n<tr>\n<td><a href=\"#series-pie\">series-pie</a></td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-scatter\">series-scatter</a></td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-effectScatter\">series-effectScatter</a></td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-radar\">series-radar</a></td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌ (✅ if via <a href=\"#radar\">radar</a> coord sys)</td>\n<td>❌ (✅ if via <a href=\"#radar\">radar</a> coord sys)</td>\n</tr>\n<tr>\n<td><a href=\"#series-tree\">series-tree</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-treemap\">series-treemap</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-sunburst\">series-sunburst</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-boxplot\">series-boxplot</a></td>\n<td>❌</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#grid\">grid</a>)</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#grid\">grid</a>)</td>\n</tr>\n<tr>\n<td><a href=\"#series-candlestick\">series-candlestick</a></td>\n<td>❌</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#grid\">grid</a>)</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#grid\">grid</a>)</td>\n</tr>\n<tr>\n<td><a href=\"#series-heatmap\">series-heatmap</a></td>\n<td>❌</td>\n<td>✅</td>\n<td>❌</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-map\">series-map</a></td>\n<td>✅ (create a geo coord sys exclusively)</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-parallel\">series-parallel</a></td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>❌ (✅ if via <a href=\"#parallel\">parallel</a> coord sys)</td>\n<td>❌ (✅ if via <a href=\"#parallel\">parallel</a> coord sys)</td>\n</tr>\n<tr>\n<td><a href=\"#series-lines\">series-lines</a></td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#geo\">geo</a>)</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#geo\">geo</a>)</td>\n</tr>\n<tr>\n<td><a href=\"#series-graph\">series-graph</a></td>\n<td>✅ (create a &quot;view&quot; coord sys exclusively)</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-sankey\">series-sankey</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-funnel\">series-funnel</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-gauge\">series-gauge</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#series-pictorialBar\">series-pictorialBar</a></td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#grid\">grid</a>)</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#grid\">grid</a>)</td>\n</tr>\n<tr>\n<td><a href=\"#series-themeRiver\">series-themeRiver</a></td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#singleAxis\">singleAxis</a>)</td>\n<td>❌ (✅ if via another coord sys like <a href=\"#singleAxis\">singleAxis</a>)</td>\n</tr>\n<tr>\n<td><a href=\"#series-chord\">series-chord</a></td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#title\">title</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#legend\">legend</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#dataZoom\">dataZoom</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#visualMap\">visualMap</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#toolbox\">toolbox</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#timeline\">timeline</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n<tr>\n<td><a href=\"#thumbnail\">thumbnail</a></td>\n<td>✅</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>❌</td>\n<td>✅</td>\n<td>✅</td>\n</tr>\n</tbody>\n</table>\n<p>See also <a href=\"#series-custom.coordinateSystemUsage\">series-custom.coordinateSystemUsage</a>.</p>\n"
    },
    "coordinateSystemUsage": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n<p>Specify how to lay out this <code class=\"codespan\">series-custom</code> based on the specified <a href=\"#series-custom.coordinateSystem\">coordinateSystem</a>.</p>\n<p>In most cases, there is no need to specify <code class=\"codespan\">coordinateSystemUsage</code>, unless the default behavior is unexpected.</p>\n<p>Options:</p>\n<ul>\n<li><p><code class=\"codespan\">&#39;data&#39;</code>: </p>\n<p>  Each data item of a series (e.g., each <code class=\"codespan\">series.data[i]</code>) is laid out separately based on the specified coordinate system. Currently no non-series component supports <code class=\"codespan\">coordinateSystemUsage: &#39;data&#39;</code>.</p>\n</li>\n<li><p><code class=\"codespan\">&#39;box&#39;</code>: <strong>(Not applicable in <a href=\"#series-custom\">series-custom</a>)</strong></p>\n<p>  The entire series or component is laid out as a whole based on the specified coordinate system - that is, the overall bounding rect or basic anchor point is calculated relative to the system.</p>\n<ul>\n<li>For example, a <a href=\"#grid\">grid component</a> can be laid out in a <a href=\"#matrix\">matrix coordinate system</a> or a <a href=\"#calendar\">calendar coordinate system</a>, where its layout rectangle is calculated by the specified <a href=\"#series-custom.coords\">series-custom.coords</a> in that system. See example <a href=\"https://echarts.apache.org/examples/en/editor.html?c=matrix-sparkline&amp;edit=1&amp;reset=1\" target=\"_blank\">sparkline in matrix</a>.</li>\n<li>For example, a <a href=\"#series-pie\">pie series</a> or a <a href=\"#series-chord\">chord series</a> can be laid out in a <a href=\"#geo\">geo coordinate system</a> or a <a href=\"#grid\">cartesian2d coordinate system</a>, where the center is calculated by the specified <a href=\"#series-pie.coords\">series-pie.coords</a> or <a href=\"#series-pie.center\">series-pie.center</a> in that system. See example <a href=\"https://echarts.apache.org/examples/en/editor.html?c=map-iceland-pie&amp;edit=1&amp;reset=1\" target=\"_blank\">pie in geo</a>.</li>\n</ul>\n</li>\n</ul>\n<p>Only a few series support both <code class=\"codespan\">coordinateSystemUsage: &#39;data&#39;</code> and <code class=\"codespan\">coordinateSystemUsage: &#39;box&#39;</code>, such as <a href=\"#series-graph\">series-graph</a>, <a href=\"#series-map\">series-map</a>. For examle, in <a href=\"https://echarts.apache.org/examples/en/editor.html?c=matrix-graph&amp;edit=1&amp;reset=1\" target=\"_blank\">this example (coordinateSystemUsage: &#39;data&#39;)</a>, each node of a graph series is laid out on a matrix coordinate system, while in <a href=\"https://echarts.apache.org/examples/en/editor.html?c=doc-example/matrix-graph-box&amp;edit=1&amp;reset=1\" target=\"_blank\">this example (coordinateSystemUsage: &#39;box&#39;)</a>, the entire graph series is laid out within a matrix cell.</p>\n<p>Most series only support <code class=\"codespan\">coordinateSystemUsage: &#39;data&#39;</code> - such as <a href=\"#series-line\">series-line</a>, <a href=\"#series-bar\">series-bar</a>, <a href=\"#series-scatter\">series-scatter</a>, etc. Meanwhile, some series only support <code class=\"codespan\">coordinateSystemUsage: &#39;box&#39;</code> - such as <a href=\"#series-pie\">series-pie</a> (<a href=\"https://echarts.apache.org/examples/en/editor.html?c=map-iceland-pie&amp;edit=1&amp;reset=1\" target=\"_blank\">example: pie in geo</a>), <a href=\"#series-pie\">series-tree</a>, <a href=\"#series-treemap\">series-treemap</a>, <a href=\"#series-sankey\">series-sankey</a>, etc.</p>\n<p>See also <a href=\"#series-custom.coordinateSystem\">series-custom.coordinateSystem</a>.</p>\n"
    },
    "coord": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n<p>When <a href=\"#series-custom.coordinateSystemUsage\">coordinateSystemUsage</a> is <code class=\"codespan\">&#39;box&#39;</code>, <code class=\"codespan\">coord</code> is used as the input to the coordinate system and calculate the layout rectangle or anchor point.</p>\n<p>Examples: <a href=\"https://echarts.apache.org/examples/en/editor.html?c=matrix-sparkline&amp;edit=1&amp;reset=1\" target=\"_blank\">sparkline in matrix</a>, <a href=\"https://echarts.apache.org/examples/en/editor.html?c=doc-example/matrix-graph-box&amp;edit=1&amp;reset=1\" target=\"_blank\">grpah in matrix</a>.</p>\n<blockquote>\n<p>Note: when <a href=\"#series-custom.coordinateSystemUsage\">coordinateSystemUsage</a> is <code class=\"codespan\">&#39;data&#39;</code>, the input of coordinate system is <code class=\"codespan\">series.data[i]</code> rather than this <code class=\"codespan\">coord</code>.</p>\n</blockquote>\n<p>The format this <code class=\"codespan\">coord</code> is defined by each coordinate system, and it&#39;s the same as the second parameter of <a href=\"api.html#echartsInstance.convertToPixel\" target=\"_blank\">chart.convertToPixel</a>.</p>\n"
    },
    "xAxisIndex": {
      "desc": "<p>The index of the <a href=\"#xAxis\">xAxis</a> to base on. When mutiple <code class=\"codespan\">xAxis</code> components exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">xAxis</code>.</p>\n"
    },
    "xAxisId": {
      "desc": "<p>The id of the <a href=\"#xAxis\">xAxis</a> to base on. When mutiple <code class=\"codespan\">xAxis</code> components exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">xAxis</code>.</p>\n"
    },
    "yAxisIndex": {
      "desc": "<p>The index of the <a href=\"#yAxis\">yAxis</a> to base on. When mutiple <code class=\"codespan\">yAxis</code> components exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">yAxis</code>.</p>\n"
    },
    "yAxisId": {
      "desc": "<p>The index of the <a href=\"#yAxis\">yAxis</a> to base on. When mutiple <code class=\"codespan\">yAxis</code> components exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">yAxis</code>.</p>\n"
    },
    "polarIndex": {
      "desc": "<p>The index of the <a href=\"#polar\">polar coordinate system</a> to base on. When mutiple <code class=\"codespan\">polar</code> exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">polar</code>.</p>\n"
    },
    "polarId": {
      "desc": "<p>The id of the <a href=\"#polar\">polar coordinate system</a> to base on. When mutiple <code class=\"codespan\">polar</code> exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">polar</code>.</p>\n"
    },
    "singleAxisIndex": {
      "desc": "<p>The index of the <a href=\"#singleAxis\">singleAxis coordinate system</a> to base on. When mutiple <code class=\"codespan\">singleAxis</code> exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">singleAxis</code>.</p>\n"
    },
    "singleAxisId": {
      "desc": "<p>The id of the <a href=\"#singleAxis\">singleAxis coordinate system</a> to base on. When mutiple <code class=\"codespan\">singleAxis</code> exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">singleAxis</code>.</p>\n"
    },
    "geoIndex": {
      "desc": "<p>The index of the <a href=\"#geo\">geographic coordinate system</a> to base on. When mutiple <code class=\"codespan\">geographic</code> exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">geographic</code>.</p>\n<p><strong>See example</strong>: <a href=\"https://echarts.apache.org/examples/en/editor.html?c=geo-choropleth-scatter&amp;reset=1&amp;edit=1\" target=\"_blank\">geo-choropleth-scatter</a></p>\n"
    },
    "geoId": {
      "desc": "<p>The id of the <a href=\"#geo\">geographic coordinate system</a> to base on. When mutiple <code class=\"codespan\">geographic</code> exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">geographic</code>.</p>\n<p><strong>See example</strong>: <a href=\"https://echarts.apache.org/examples/en/editor.html?c=geo-choropleth-scatter&amp;reset=1&amp;edit=1\" target=\"_blank\">geo-choropleth-scatter</a></p>\n"
    },
    "calendarIndex": {
      "desc": "<p>The index of the <a href=\"#calendar\">calendar coordinate system</a> to base on. When mutiple <code class=\"codespan\">calendar</code> exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">calendar</code>.</p>\n"
    },
    "calendarId": {
      "desc": "<p>The id of the <a href=\"#calendar\">calendar coordinate system</a> to base on. When mutiple <code class=\"codespan\">calendar</code> exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">calendar</code>.</p>\n"
    },
    "matrixIndex": {
      "desc": "<p>The index of the <a href=\"#matrix\">matrix coordinate system</a> to base on. When mutiple <code class=\"codespan\">matrix</code> exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">matrix</code>.</p>\n"
    },
    "matrixId": {
      "desc": "<p>The id of the <a href=\"#matrix\">matrix coordinate system</a> to base on. When mutiple <code class=\"codespan\">matrix</code> exist within an ECharts instance, use this to specify the corresponding <code class=\"codespan\">matrix</code>.</p>\n"
    },
    "renderItem": {
      "desc": "<p><code class=\"codespan\">custom series</code> requires developers to write a rendering logic by themselves in the form of <code class=\"codespan\">Function</code>, or use a registered rendering logic in the form of <code class=\"codespan\">string</code> (since <code class=\"codespan\">v6.0.0</code>; See <a href=\"api.html#echarts.registerCustomSeries\" target=\"_blank\">echarts.registerCustomSeries</a> for more information). This render logic is called <a href=\"#series-custom.renderItem\">renderItem</a>.</p>\n<p>For example:</p>\n<pre><code class=\"lang-ts\">var option = {\n    ...,\n    series: [{\n        type: &#39;custom&#39;,\n        renderItem: function (params, api) {\n            var categoryIndex = api.value(0);\n            var start = api.coord([api.value(1), categoryIndex]);\n            var end = api.coord([api.value(2), categoryIndex]);\n            var height = api.size([0, 1])[1] * 0.6;\n\n            var rectShape = echarts.graphic.clipRectByRect({\n                x: start[0],\n                y: start[1] - height / 2,\n                width: end[0] - start[0],\n                height: height\n            }, {\n                x: params.coordSys.x,\n                y: params.coordSys.y,\n                width: params.coordSys.width,\n                height: params.coordSys.height\n            });\n\n            return rectShape &amp;&amp; {\n                type: &#39;rect&#39;,\n                shape: rectShape,\n                style: api.style()\n            };\n        },\n        data: data\n    }]\n}\n</code></pre>\n<p><a href=\"#series-custom.renderItem\">renderItem</a> will be called on each data item.</p>\n<p><a href=\"#series-custom.renderItem\">renderItem</a> provides two parameters:</p>\n<ul>\n<li><a href=\"#series-custom.renderItem.arguments.params\">params</a>: provides info about the current series and data and coordinate system.</li>\n<li><a href=\"#series-custom.renderItem.arguments.api\">api</a>: includes some methods.</li>\n</ul>\n<p><a href=\"#series-custom.renderItem\">renderItem</a> method should returns graphic elements definitions.See <a href=\"#series-custom.renderItem.return\">renderItem.return</a>.</p>\n<p>Generally, the main process of <a href=\"#series-custom.renderItem\">renderItem</a> is that retrieve value from data and convert them to graphic elements on the current coordinate system. Two methods in <a href=\"#series-custom.renderItem.arguments.api\">renderItem.arguments.api</a> are always used in this procedure:</p>\n<ul>\n<li><a href=\"#series-custom.renderItem.arguments.api.value\">api.value(...)</a> is used to retrieve value from data. For example, <code class=\"codespan\">api.value(0)</code> retrieve the value of the first dimension in the current data item.</li>\n<li><a href=\"#series-custom.renderItem.arguments.api.coord\">api.coord(...)</a> is used to convert data to coordinate. For example, <code class=\"codespan\">var point = api.coord([api.value(0), api.value(1)])</code> converet the data to the point on the current coordinate system.</li>\n</ul>\n<p>Sometimes <a href=\"#series-custom.renderItem.arguments.api.size\">api.size(...)</a> method is needed, which calculates the size on the coordinate system by a given data range.</p>\n<p>Moreover, <a href=\"#series-custom.renderItem.arguments.api.style\">api.style(...)</a> method can be used to set style. It provides not only the style settings specified in <a href=\"#series-custom.itemStyle\">series.itemStyle</a>, but also the result of visual mapping. This method can also be called like <code class=\"codespan\">api.style({fill: &#39;green&#39;, stroke: &#39;yellow&#39;})</code> to override those style settings.</p>\n"
    },
    ...
    "renderItem.arguments.api.coord": {
      "desc": "<p>Convert data to coordinate.</p>\n<p>The behavior, parameters and returns are the same as <a href=\"api.html#echartsInstance.convertToPixel\" target=\"_blank\">chart.convertToPixel</a> (only exclude its first parameter <code class=\"codespan\">finder</code>).</p>\n"
    },
    "renderItem.arguments.api.layout": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n<p>Convert data to the corresponding layout info based on the current coordinate system.</p>\n<p>The behavior, parameters and returns are the same as <a href=\"api.html#echartsInstance.convertToLayout\" target=\"_blank\">chart.convertToLayout</a> (only exclude its first parameter <code class=\"codespan\">finder</code>).</p>\n<p>See <a href=\"https://echarts.apache.org/examples/en/editor.html?c=matrix-mini-bar-data-collection\" target=\"_blank\">matrix api.layout example</a>.</p>\n"
    },
    ...
    "renderItem.arguments.api.getWidth": {
      "desc": "<pre><code>@return {number} Width of echarts container.\n</code></pre>"
    },
    ...
    "renderItem.return_group.enterAnimation.duration": {
      "desc": "<p>Duration of animation, unit: ms</p>\n"
    },
    "renderItem.return_group.enterAnimation.easing": {
      "desc": "<p>Easing effect. Refer to the following for different effects: <a href=\"https://echarts.apache.org/examples/en/editor.html?c=line-easing\" target=\"_blank\">examples</a></p>\n"
    },
    "renderItem.return_group.enterAnimation.delay": {
      "desc": "<p>Delay of animation, unit: ms</p>\n"
    },
    ...
    "renderItem.return_group.tooltipDisabled": {
      "desc": "<p>Whether disable triggering tooltip.</p>\n<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n\n\n\n\n\n\n"
    },
    ...
    "renderItem.return_path.style.lineDash": {
      "desc": "<p>Sets the line dash pattern used when stroking lines. Possible values are:</p>\n<ul>\n<li><code class=\"codespan\">&#39;solid&#39;</code></li>\n<li><code class=\"codespan\">&#39;dashed&#39;</code></li>\n<li><code class=\"codespan\">&#39;dotted&#39;</code></li>\n<li><code class=\"codespan\">number</code> / <code class=\"codespan\">number</code> array. See <a href=\"https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/setLineDash\" target=\"_blank\">MDN</a> for more information.</li>\n</ul>\n"
    },
    "renderItem.return_path.style.lineDashOffset": {
      "desc": "<p>Sets the line dash offset used when stroking lines. See <a href=\"https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineDashOffset\" target=\"_blank\">MDN</a> for more information.</p>\n"
    },
    "renderItem.return_path.style.lineCap": {
      "desc": "<p>Line cap style. See <a href=\"https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineCap\" target=\"_blank\">MDN</a> for more information.</p>\n"
    },
    "renderItem.return_path.style.lineJoin": {
      "desc": "<p>Line join style. See <a href=\"https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineJoin\" target=\"_blank\">MDN</a> for more information.</p>\n"
    },
    "renderItem.return_path.style.miterLimit": {
      "desc": "<p>Sets the miter limit ratio. See <a href=\"https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/miterLimit\" target=\"_blank\">MDN</a> for more information.</p>\n"
    },
    ...
    "renderItem.return_path.style.opacity": {
      "desc": "<p>Opacity of this element.</p>\n"
    },
    ...
    "renderItem.return_sector.shape.cornerRadius": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v5.3.0</code>\n\n</div>\n\n\n\n\n<p>The corner radius of the sector.</p>\n<ul>\n<li><code class=\"codespan\">cornerRadius: 10</code>: Indicates that both the inner and outer corner radii are 10px.</li>\n<li><code class=\"codespan\">cornerRadius: [10, 20]</code>: When applied to a ring chart, the inner corner radius is 10px and the outer corner radius is 20px.</li>\n<li><code class=\"codespan\">cornerRadius: [5, 10, 15, 20]</code>: Indicates that the inner corner radii are 5px and 10px, and the outer corner radii are 15px and 20px.</li>\n</ul>\n"
    },
    ...
    "renderItem.return_compoundPath": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v6.0.0</code>\n\n</div>\n\n\n\n\n<p>The union of multiple elements.</p>\n"
    },
    ...
    "renderItem.return_compoundPath.transition": {
      "desc": "<p>You can specify that all properties have transition animations turned on with `&#39;all&#39;&#39;, or you can specify a single property or an array of properties.</p>\n<p>The properties can be:</p>\n<p>Transform related properties:<code class=\"codespan\">&#39;x&#39;</code>, <code class=\"codespan\">&#39;y&#39;</code>, <code class=\"codespan\">&#39;scaleX&#39;</code>, <code class=\"codespan\">&#39;scaleY&#39;</code>, <code class=\"codespan\">&#39;rotation&#39;</code>, <code class=\"codespan\">&#39;originX&#39;</code>, <code class=\"codespan\">&#39;originY&#39;</code>. For example:</p>\n<pre><code class=\"lang-ts\">{\n    type: &#39;rect&#39;,\n    x: 100,\n    y: 200,\n    transition: [&#39;x&#39;, &#39;y&#39;]\n}\n</code></pre>\n<p>Shortcut to transition all of the properties in <a href=\"#series-custom.renderItem.return_compoundPath.shape\"><code class=\"codespan\">&#39;shape&#39;</code></a>, <a href=\"#series-custom.renderItem.return_compoundPath.style\">&#39;<code class=\"codespan\">style&#39;</code></a>, <a href=\"#series-custom.renderItem.return_compoundPath.extra\"><code class=\"codespan\">&#39;extra&#39;</code></a>. For example:</p>\n<pre><code class=\"lang-ts\">{\n    type: &#39;rect&#39;,\n    shape: { // ... },\n    // Indicate that all props in `shape` will\n    // have transition animation.\n    transition: &#39;shape&#39;,\n}\n</code></pre>\n<p>In the custom series. <code class=\"codespan\">&#39;x&#39;</code> and <code class=\"codespan\">&#39;y&#39;</code> are transitioned by default. If you want to disable the default transition, just set it as: <code class=\"codespan\">transition: []</code>.</p>\n<p>See this <a href=\"https://echarts.apache.org/examples/en/editor.html?c=doc-example/custom-transition-simple&amp;edit=1&amp;reset=1\" target=\"_blank\">example</a> please.</p>\n"
    },
    ...
    "renderItem.return_compoundPath.name": {
      "desc": "<p>See <a href=\"#series-custom.renderItem.return_compoundPath.diffChildrenByName\">diffChildrenByName</a>.</p>\n"
    },
    ...
    "renderItem.return_compoundPath.shape.paths": {
      "desc": "<p>Array of elements, each of which can be a path/rect/circle/...</p>\n"
    },
    ...
    "data.groupId": {
      "desc": "<p>The group ID of a data item. When <code class=\"codespan\">universalTransition</code> is enabled, the data items from the old option and those from the new one, if sharing a same group ID, will then be matched and applied to a proper animation after <code class=\"codespan\">setOption</code> is called.</p>\n<p>If a data item is not specified with a <code class=\"codespan\">groupId</code>, Apache ECharts will try to use <code class=\"codespan\">series.dataGroupId</code> as the group ID for the data item. If <code class=\"codespan\">series.dataGroupId</code> is not specified either, Apache ECharts will fall back to using the data item&#39;s ID as its group ID.</p>\n<p>If you are using the <a href=\"#dataset\">dataset</a> component to represent data, you are recommended to use <code class=\"codespan\">encode.itemGroupId</code> to specify the dimension that is to be encoded as the group ID.</p>\n"
    },
    "data.childGroupId": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v5.5.0</code>\n\n</div>\n\n\n\n\n<p>The group ID of the child data of a data item. This option is introduced to make multiple levels drilldown and aggregation animation possilbe.</p>\n<iframe  data-src=\"https://echarts.apache.org/examples/en/view.html?c=doc-example/bar-multi-drilldown&edit=1&reset=1\" width=\"700\" height=\"300\"></iframe>\n\n\n<p>Before <code class=\"codespan\">childGroupId</code> is introduced, developers actually can use <code class=\"codespan\">groupId</code> to make drilldown and aggregation animation already, but with the limit on the times that a continious drilldown or aggregation can happen, which is only one time.</p>\n<p><code class=\"codespan\">childGroupId</code>, together with <code class=\"codespan\">groupId</code>, help to form &quot;parent-child&quot; relationships between data items of different options, such as:</p>\n<pre><code class=\"lang-text\">data: [                        data: [                        data: [\n  {                              {                              {\n    name: &#39;Animals&#39;,               name: &#39;Dogs&#39;,                  name: &#39;Corgi&#39;,\n    value: 3,                      value: 3,                      value: 5,\n    groupId: &#39;things&#39;,             groupId: &#39;animals&#39;,            groupId: &#39;dogs&#39;\n    childGroupId: &#39;animals&#39;        childGroupId: &#39;dogs&#39;         },\n  },                             },                             {\n  {                              {                                name: &#39;Bulldog&#39;,\n    name: &#39;Fruits&#39;,                name: &#39;Cats&#39;,                  value: 6,\n    value: 3,                      value: 4,                      groupId: &#39;dogs&#39;\n    groupId: &#39;things&#39;,             groupId: &#39;animals&#39;,          },\n    childGroupId: &#39;fruits&#39;         childGroupId: &#39;cats&#39;,        {\n  },                             },                               name: &#39;Shiba Inu&#39;,\n  {                              {                                value: 7,\n    name: &#39;Cars&#39;,                  name: &#39;Birds&#39;,                 groupId: &#39;dogs&#39;\n    value: 2,                      value: 3,                    }\n    groupId: &#39;things&#39;,             groupId: &#39;animals&#39;,        ]\n    childGroupId: &#39;cars&#39;           childGroupId: &#39;birds&#39;\n  }                              }\n]                              ]\n</code></pre>\n<p>The 3 groups of data above come from 3 options, and by specifying <code class=\"codespan\">groupId</code> and <code class=\"codespan\">childGroupId</code> for the data items a relationship of &quot;parent-child-grandChild&quot; is formed in the 3 options. In this way,  after <code class=\"codespan\">setOption</code> is called, Apache ECharts will try to find the &quot;parent-child&quot; or &quot;child-parent&quot; relationship of the old option and the new one. If the relationship exists, the matching data items will be applied to a drilldown animation or an aggregation one.</p>\n<p>If a data item has no child data then there is no need to specify a <code class=\"codespan\">childGroupId</code> at all.</p>\n<p>If you are using the <a href=\"#dataset\">dataset</a> component to represent data, you are recommended to use <code class=\"codespan\">encode.itemChildGroupId</code> to specify the dimension that is to be encoded as the child group ID.</p>\n"
    },
    ...
    "data.tooltip.textStyle": {
      "desc": "<blockquote>\n<p><strong>Notice：</strong>series.data.tooltip only works when <a href=\"#tooltip.trigger\">tooltip.trigger</a> is <code class=\"codespan\">&#39;item&#39;</code>.<br></p>\n</blockquote>\n<p>The text style of tooltip&#39;s floating layer.</p>\n"
    },
    ...
    "data.tooltip.extraCssText": {
      "desc": "\n\n\n\n\n<blockquote>\n<p><strong>Notice：</strong>series.data.tooltip only works when <a href=\"#tooltip.trigger\">tooltip.trigger</a> is <code class=\"codespan\">&#39;item&#39;</code>.<br></p>\n</blockquote>\n<p>Extra CSS style for floating layer. The following is an example for adding shadow.</p>\n<pre><code class=\"lang-ts\">extraCssText: &#39;box-shadow: 0 0 3px rgba(0, 0, 0, 0.3);&#39;\n</code></pre>\n<div  class=\"doc-partial-security-warning\">\n<span  class=\"warning-title\">[WARNING]:</span> <code  class=\"codespan\">tooltip</code> is implemented in HTML (unless <a  href=\"#tooltip.renderMode\">tooltip.renderMode</a> is set as <code  class=\"codespan\">richText</code>), allowing users to customize the CSS text of the box in this way. <strong >Security risks</strong> must be considered if the CSS text comes from untrusted sources. See document <a  href=\"https://echarts.apache.org/handbook/en/best-practices/security\" target=\"_blank\">&quot;Security Guidelines&quot;</a> for recommendations on safe usage.\n</div>\n\n\n\n\n\n\n\n\n\n\n",
      "uiControl": {
        "type": "text"
      }
    },
    "clip": {
      "desc": "\n\n\n\n<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v4.4.0</code>\n\n</div>\n\n\n\n\n<p>If clip the overflow on the coordinate system. Clip results varies between series:</p>\n<ul>\n<li>Scatter/EffectScatter：Ignore the symbols exceeds the coordinate system. Not clip the elements.</li>\n<li>Bar：Clip all the overflowed. With bar width kept.</li>\n<li>Line：Clip the overflowed line.</li>\n<li>Lines: Clip all the overflowed.</li>\n<li>Candlestick: Ignore the elements exceeds the coordinate system.</li>\n<li>PictorialBar: Clip all the overflowed. (Supported since v5.5.0)</li>\n<li>Custom: Clip all the olverflowed.</li>\n</ul>\n<p>All these series have default value <code class=\"codespan\">true</code> except pictorialBar and custom series. Set it to <code class=\"codespan\">false</code> if you don&#39;t want to clip.</p>\n",
      "uiControl": {
        "type": "boolean",
        "default": "false"
      }
