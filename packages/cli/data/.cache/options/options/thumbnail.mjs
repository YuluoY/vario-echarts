{
  "__EC_DOC_option_thumbnail": {
    ...
    "seriesIndex": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>指定此缩略图作用在哪个系列上。默认取第一个 <a href=\"#series-graph\">关系图系列（series.graph）</a>。</p>\n"
    },
    "seriesId": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>指定此缩略图作用在哪个系列上。默认取第一个 <a href=\"#series-graph\">关系图系列（series.graph）</a>。</p>\n"
    }
