{
  "__EC_DOC_option_radiusAxis": {
    ...
    "axisLabel.padding": {
      "desc": "\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class=\"codespan\">padding: [3, 4, 5, 6]</code>：表示 <code class=\"codespan\">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class=\"codespan\">padding: 4</code>：表示 <code class=\"codespan\">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class=\"codespan\">padding: [3, 4]</code>：表示 <code class=\"codespan\">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class=\"codespan\">width</code> 和 <code class=\"codespan\">height</code> 指定的是内��高宽，不包含 <code class=\"codespan\">padding</code>。</p>\n",
      "uiControl": {
        "type": "vector",
        "min": "0",
        "dims": "T,R,B,L"
    ...
    "tooltip": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.6.0</code> 开始支持\n\n</div>\n\n\n\n<p>坐标轴 tooltip 设置，注意需设置 <a href=\"#radiusAxis.triggerEvent\">triggerEvent</a> 为 <code class=\"codespan\">true</code> 并启用全局 <a href=\"#tooltip\">option.tooltip</a> 组件。</p>\n"
    },
    "tooltip.show": {
      "desc": "\n\n<p>是否显示提示框组件，默认不启用。</p>\n",
      "uiControl": {
