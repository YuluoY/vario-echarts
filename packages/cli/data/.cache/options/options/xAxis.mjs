{
  "__EC_DOC_option_xAxis": {
    ...
    "nameTextStyle.overflow": {
      "desc": "\n\n<p>文字超出宽度是否截断或者换行。配置<code class=\"codespan\">width</code>时有效</p>\n<ul>\n<li><code class=\"codespan\">&#39;truncate&#39;</code> 截断，并在末尾显示<code class=\"codespan\">ellipsis</code>配置的文本，默认为<code class=\"codespan\">...</code></li>\n<li><code class=\"codespan\">&#39;break&#39;</code> 换行</li>\n<li><code class=\"codespan\">&#39;breakAll&#39;</code> 换行，跟<code class=\"codespan\">&#39;break&#39;</code>不同的是，在英语等拉丁文���，<code class=\"codespan\">&#39;breakAll&#39;</code>还会强制单词内换行</li>\n</ul>\n",
      "uiControl": {
        "type": "enum",
    ...
    "jitterOverlap": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>是否允许 <a href=\"#xAxis.jitter\">jitter</a> 重叠。如果设为 <code class=\"codespan\">false</code>，将尽可能避免重叠，极端情况下如果重叠是无法避免的，则也可能出现重叠。以下是设为 <code class=\"codespan\">false</code> 的效果：</p>\n<iframe  data-src=\"https://echarts.apache.org/examples/zh/view.html?c=doc-example/scatter-jitter-avoidOverlap&edit=1&reset=1\" width=\"800\" height=\"500\"></iframe>\n\n"
    },
    "jitterMargin": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>在设置了 <a href=\"#xAxis.jitter\">jitter</a> 且 <a href=\"#xAxis.jitterOverlap\">jitterOverlap</a> 为 <code class=\"codespan\">false</code> 的情况下，两个数据点之间的最小距离。</p>\n"
    },
    "breaks": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>断轴的截断数据，每一个子元素表示一段截断的空间。</p>\n<iframe  data-src=\"https://echarts.apache.org/examples/zh/view.html?c=intraday-breaks-2&edit=1&reset=1\" width=\"800\" height=\"400\"></iframe>\n\n<iframe  data-src=\"https://echarts.apache.org/examples/zh/view.html?c=intraday-breaks-1&edit=1&reset=1\" width=\"800\" height=\"400\"></iframe>\n\n<iframe  data-src=\"https://echarts.apache.org/examples/zh/view.html?c=bar-breaks-brush&edit=1&reset=1\" width=\"800\" height=\"400\"></iframe>\n\n\n<p><strong>其他例子：</strong> <a href=\"https://echarts.apache.org/examples/zh/editor.html?c=bar-breaks-simple&amp;edit=1&amp;reset=1\" target=\"_blank\">bar-breaks-simple</a>, <a href=\"https://echarts.apache.org/examples/zh/editor.html?c=line-fisheye-lens&amp;edit=1&amp;reset=1\" target=\"_blank\">line-fisheye-lens</a></p>\n<blockquote>\n<p>断轴是一种通过在坐标轴上截断部分区域，从而压缩图表中非关键数据段的展示空间的技术。其核心目的是：</p>\n<ul>\n<li>​<strong>​突出差异</strong>​​：当数据间存在极端差异时（如一个值远大于其他值），避免大数值柱子压倒性占据空间，导致小数值差异难以辨认。</li>\n<li><strong>​​节省空间​</strong>​：减少因极值导致的空白区域，使图表更紧凑。</li>\n</ul>\n<p>请注意仅在必要的时候使用断轴，以免给用户带来理解上的误导。当使用断轴时，通常应当明确示意截断部分和对应的数值。</p>\n<p>断轴无法在类目轴（<a href=\"#xAxis.type\">type</a>: <code class=\"codespan\">&#39;category&#39;</code>）中使用。</p>\n</blockquote>\n<p>如果 ECharts 的 <code class=\"codespan\">import</code> 方式是 <a href=\"https://echarts.apache.org/handbook/zh/basics/import\" target=\"_blank\">只 <code class=\"codespan\">import</code> 所需要的组件</a>，断轴功能需要被手动 <code class=\"codespan\">import</code> 和注册。例如，</p>\n<pre><code class=\"lang-ts\">import * as echarts from &#39;echarts/core&#39;;\nimport { BarChart } from &#39;echarts/charts&#39;;\nimport {\n  TitleComponent,\n  TooltipComponent,\n  GridComponent,\n  DatasetComponent,\n  TransformComponent\n} from &#39;echarts/components&#39;;\n\n// import 断轴功能\nimport { AxisBreak } from &#39;echarts/features&#39;;\n\nimport { CanvasRenderer } from &#39;echarts/renderers&#39;;\n\n// 注册\necharts.use([\n  BarChart,\n  TitleComponent,\n  TooltipComponent,\n  GridComponent,\n  DatasetComponent,\n  TransformComponent,\n  AxisBreak,\n  CanvasRenderer\n]);\n\nvar myChart = echarts.init(document.getElementById(&#39;main&#39;));\nmyChart.setOption({\n  // ...\n});\n</code></pre>\n"
    },
    "breaks.start": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>开始截断的值。它是业务数据（<code class=\"codespan\">series.data</code>）所定义的值域中的某个值，而非像素值。</p>\n<ul>\n<li><p>如果 <a href=\"#xAxis.type\">axis.type</a> 是 <code class=\"codespan\">&#39;value&#39;</code> 或 <code class=\"codespan\">&#39;log&#39;</code>，则使用 <code class=\"codespan\">number</code> 类型的值。</p>\n</li>\n<li><p>如果 <a href=\"#xAxis.type\">axis.type</a> 是 <code class=\"codespan\">&#39;category&#39;</code>：不支持。</p>\n</li>\n<li><p>如果 <a href=\"#xAxis.type\">axis.type</a> 是 <code class=\"codespan\">&#39;time&#39;</code>，值可以是：</p>\n<ul>\n<li><code class=\"codespan\">string</code> 类型，表示任意能被 <a href=\"https://github.com/apache/echarts/blob/master/src/util/number.ts\" target=\"_blank\">方法 <code class=\"codespan\">parseDate</code> (<code class=\"codespan\">echarts/src/util/number.ts</code>)</a> 解析的时间格式，例如 <code class=\"codespan\">&#39;2024-04-09 13:00:00&#39;</code>。</li>\n<li><code class=\"codespan\">number</code> 类型，表示时间戳，例如 <code class=\"codespan\">1712667600000</code>。</li>\n<li><code class=\"codespan\">Date</code> 类型的时间对象，例如 <code class=\"codespan\">new Date(&#39;2024-04-09T13:00:00Z&#39;)</code>。</li>\n</ul>\n</li>\n</ul>\n<p>注：<a href=\"#xAxis.breaks.start\">xAxis.breaks.start</a> 和 <a href=\"#xAxis.breaks.end\">xAxis.breaks.end</a> 是每个 break 项的唯一标志。当调用 <a href=\"api.html#echartsInstance.setOption\" target=\"_blank\">chart.setOption</a> 修改 <a href=\"#xAxis.breaks.gap\">xAxis.breaks.gap</a> 或 <a href=\"#xAxis.breaks.isExpanded\">xAxis.breaks.isExpanded</a> 时，<code class=\"codespan\">start</code> <code class=\"codespan\">end</code> 必须指定，且如果 <code class=\"codespan\">start</code> <code class=\"codespan\">end</code> 不修改才会有更新动画，修改了则无。</p>\n"
    },
    "breaks.end": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>结束截断的值。它是业务数据（<code class=\"codespan\">series.data</code>）所定义的值域中的某个值，而非像素值。</p>\n<ul>\n<li><p>如果 <a href=\"#xAxis.type\">axis.type</a> 是 <code class=\"codespan\">&#39;value&#39;</code> 或 <code class=\"codespan\">&#39;log&#39;</code>，则使用 <code class=\"codespan\">number</code> 类型的值。</p>\n</li>\n<li><p>如果 <a href=\"#xAxis.type\">axis.type</a> 是 <code class=\"codespan\">&#39;category&#39;</code>：不支持。</p>\n</li>\n<li><p>如果 <a href=\"#xAxis.type\">axis.type</a> 是 <code class=\"codespan\">&#39;time&#39;</code>，值可以是：</p>\n<ul>\n<li><code class=\"codespan\">string</code> 类型，表示任意能被 <a href=\"https://github.com/apache/echarts/blob/master/src/util/number.ts\" target=\"_blank\">方法 <code class=\"codespan\">parseDate</code> (<code class=\"codespan\">echarts/src/util/number.ts</code>)</a> 解析的时间格式，例如 <code class=\"codespan\">&#39;2024-04-09 13:00:00&#39;</code>。</li>\n<li><code class=\"codespan\">number</code> 类型，表示时间戳，例如 <code class=\"codespan\">1712667600000</code>。</li>\n<li><code class=\"codespan\">Date</code> 类型的时间对象，例如 <code class=\"codespan\">new Date(&#39;2024-04-09T13:00:00Z&#39;)</code>。</li>\n</ul>\n</li>\n</ul>\n<p>注：<a href=\"#xAxis.breaks.start\">xAxis.breaks.start</a> 和 <a href=\"#xAxis.breaks.end\">xAxis.breaks.end</a> 是每个 break 项的唯一标志。当调用 <a href=\"api.html#echartsInstance.setOption\" target=\"_blank\">chart.setOption</a> 修改 <a href=\"#xAxis.breaks.gap\">xAxis.breaks.gap</a> 或 <a href=\"#xAxis.breaks.isExpanded\">xAxis.breaks.isExpanded</a> 时，<code class=\"codespan\">start</code> <code class=\"codespan\">end</code> 必须指定，且如果 <code class=\"codespan\">start</code> <code class=\"codespan\">end</code> 不修改才会有更新动画，修改了则无。</p>\n"
    },
    "breaks.gap": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>决定了断轴截断区域最终展示的尺寸（高或者宽）。其值可为：</p>\n<ul>\n<li><p>百分比（字符串）：</p>\n<p>  表示相对于坐标轴的比例。例如 <code class=\"codespan\">&#39;5%&#39;</code>，表示断轴截断区域最终显示的尺寸总为坐标轴尺寸的 <code class=\"codespan\">&#39;5%&#39;</code>。使用百分比能保证断轴截断区域的像素尺寸稳定，不随着 <a href=\"#xAxis.min\">xAxis.min</a>、<a href=\"#xAxis.max\">xAxis.max</a>、<a href=\"#dataZoom\">dataZoom</a> 变化而变化，因此目前大多数场景都适合使用百分比。</p>\n</li>\n<li><p>绝对值：</p>\n<p>  其单位和 <a href=\"#xAxis.breaks.start\">start</a> 与 <a href=\"#xAxis.breaks.end\">end</a> 相同，是业务数据（<code class=\"codespan\">series.data</code>）所定义的值域中的某个值，而非像素值。它表示把 <code class=\"codespan\">[start, end]</code> 这个区间映射（替换）为 <code class=\"codespan\">[start, start + gap]</code>。因此，设为绝对值时，断轴截断区域的像素尺寸会随着 <a href=\"#xAxis.min\">xAxis.min</a>、<a href=\"#xAxis.max\">xAxis.max</a>、<a href=\"#dataZoom\">dataZoom</a> 变化而变化。</p>\n</li>\n</ul>\n<p><strong>注意：</strong>在一个 <a href=\"#xAxis.breaks\">xAxis.breaks</a> 数组中，<code class=\"codespan\">gap</code> 只允许全使用百分比，或者全使用绝对值，不允许混合使用，否者效果可能不符合预期。</p>\n<p>注：<a href=\"#xAxis.breaks.start\">xAxis.breaks.start</a> 和 <a href=\"#xAxis.breaks.end\">xAxis.breaks.end</a> 是每个 break 项的唯一标志。当调用 <a href=\"api.html#echartsInstance.setOption\" target=\"_blank\">chart.setOption</a> 修改 <a href=\"#xAxis.breaks.gap\">xAxis.breaks.gap</a> 或 <a href=\"#xAxis.breaks.isExpanded\">xAxis.breaks.isExpanded</a> 时，<code class=\"codespan\">start</code> <code class=\"codespan\">end</code> 必须指定，且如果 <code class=\"codespan\">start</code> <code class=\"codespan\">end</code> 不修改才会有更新动画，修改了则无。</p>\n"
    },
    "breaks.isExpanded": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>该截断区域是否已展开，默认为 <code class=\"codespan\">false</code>。</p>\n<p>注：<a href=\"#xAxis.breaks.start\">xAxis.breaks.start</a> 和 <a href=\"#xAxis.breaks.end\">xAxis.breaks.end</a> 是每个 break 项的唯一标志。当调用 <a href=\"api.html#echartsInstance.setOption\" target=\"_blank\">chart.setOption</a> 修改 <a href=\"#xAxis.breaks.gap\">xAxis.breaks.gap</a> 或 <a href=\"#xAxis.breaks.isExpanded\">xAxis.breaks.isExpanded</a> 时，<code class=\"codespan\">start</code> <code class=\"codespan\">end</code> 必须指定，且如果 <code class=\"codespan\">start</code> <code class=\"codespan\">end</code> 不修改才会有更新动画，修改了则无。</p>\n"
    },
    "breakArea": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>断轴截断区域的样式。</p>\n<p>断轴的基本介绍参见 <a href=\"#xAxisbreaks\">xAxis.breaks</a>。</p>\n"
    },
    "breakArea.show": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>是否显示截断区域。</p>\n"
    },
    ...
    "tooltip": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.6.0</code> 开始支持\n\n</div>\n\n\n\n<p>坐标轴 tooltip 设置，注意需设置 <a href=\"#xAxis.triggerEvent\">triggerEvent</a> 为 <code class=\"codespan\">true</code> 并启用全局 <a href=\"#tooltip\">option.tooltip</a> 组件。</p>\n"
    },
    "tooltip.show": {
      "desc": "\n\n<p>是否显示提示框组件，默认不启用。</p>\n",
      "uiControl": {
