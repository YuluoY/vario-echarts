{
  "__EC_DOC_option_matrix": {
    ...
    "x.show": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>是否显示表头 行(如果是 <code class=\"codespan\">matrix.x</code>) 或 列(如果是 <code class=\"codespan\">matrix.y</code>)。</p>\n"
    },
    "x.data": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>指定 x 轴表头区单元格 的数据，即定义列/行。</p>\n<pre><code class=\"lang-js\">// 一行的数据\ndata: [&#39;A&#39;, &#39;B&#39;, &#39;C&#39;, &#39;D&#39;, &#39;E&#39;]\n\n// 或者如果不关心列/行名称，可以直接\ndata: Array(5).fill(null) // 五列或五行\n// 注：不支持未初始化数组项的数组：\n// data: Array(5) // ❌\n\n// 树状结构的数据\ndata: [{\n    value: &#39;A&#39;,\n    children: [\n        {\n            value: &#39;A1&#39;,\n            children: [\n                {value: &#39;A1-1&#39;},\n                {value: &#39;A1-2&#39;}\n            ]\n        },\n        {value: &#39;A2&#39;}\n    ]\n}, {\n    value: &#39;B&#39;,\n    children: [\n        {value: &#39;B1&#39;},\n        {value: &#39;B2&#39;}\n    ]\n}]\n</code></pre>\n<p>如果 <a href=\"#matrix.x.data\">matrix.x.data</a> 没有提供，它会从 <code class=\"codespan\">series.data</code> 或者 <code class=\"codespan\">dataset.source</code> 中自动收集。</p>\n<p>参见 <a href=\"https://echarts.apache.org/examples/zh/editor.html?c=matrix-mini-bar-data-collection&amp;edit=1&amp;reset=1\" target=\"_blank\">示例</a>。</p>\n<p>在这种情况下，<a href=\"#series-scatter.encode\">series.encode</a> 可指定从哪个维度收集数据。例如：</p>\n<pre><code class=\"lang-js\">var option = {\n    // matrix.x/y.data 没有指定。\n    // 于是从 series.data or dataset.source 收集。\n    matrix: {},\n    series: {\n        type: &#39;scatter&#39;,\n        coordinateSystem: &#39;matrix&#39;,\n        // 指定从 dimension index 为 3 和 2 的列收集数据。\n        encode: {x: 3, y: 2},\n        data: [\n            // 0   1    2    3    (dimension index)\n            [100, 111, 122, 133],\n            [200, 211, 222, 233],\n        ]\n    }\n}\n</code></pre>\n"
    },
    "x.data.value": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>每个表头单元格中的文字，也可用于索引这行或列。如果不指定，自动生成一个。</p>\n"
    },
    "x.data.children": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>见 <a href=\"#matrix.x.data\">matrix.x.data</a>.</p>\n"
    },
    "x.data.size": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n<p><strong>[[单元格尺寸的规则]]</strong></p>\n<ul>\n<li>配置项 <code class=\"codespan\">levelSize</code><ul>\n<li>用于指定某一行或某一列所有单元格的尺寸。<ul>\n<li>对于 <code class=\"codespan\">matrix.x</code>，指的是一行单元格的高度（&quot;level&quot; 指一行）。</li>\n<li>对于 <code class=\"codespan\">matrix.y</code>，指的是一列单元格的宽度（&quot;level&quot; 指一列）。</li>\n</ul>\n</li>\n<li>可以在以下位置声明：<ul>\n<li><code class=\"codespan\">matrix.levelSize</code>：指定所有行或列的默认尺寸。</li>\n<li><code class=\"codespan\">matrix.levels[i].levelSize</code>：指定某一行或列的尺寸。</li>\n</ul>\n</li>\n</ul>\n</li>\n<li>配置项 <code class=\"codespan\">size</code><ul>\n<li>用于指定单个单元格的尺寸。<ul>\n<li>对于 <code class=\"codespan\">matrix.x</code>，指的是单元格的宽度。</li>\n<li>对于 <code class=\"codespan\">matrix.y</code>，指的是单元格的高度。</li>\n</ul>\n</li>\n<li>可以在以下位置声明：<ul>\n<li><code class=\"codespan\">matrix.x/y.data[i].size</code></li>\n</ul>\n</li>\n</ul>\n</li>\n</ul>\n<p><code class=\"codespan\">levelSize</code> 或 <code class=\"codespan\">size</code> 的取值可以为：</p>\n<ul>\n<li>未指定（默认）：宽度或高度会被均匀分配。</li>\n<li><code class=\"codespan\">number</code>：表示像素值。</li>\n<li><code class=\"codespan\">string</code>：百分比值（如 <code class=\"codespan\">&#39;33%&#39;</code>），表示相对于矩阵宽度（在 <code class=\"codespan\">matrix.x</code> 中）或高度（在 <code class=\"codespan\">matrix.y</code> 中）的百分比。</li>\n</ul>\n<p>例如：</p>\n<pre><code class=\"lang-js\">{\n    matrix: {\n        x: {\n            // 第二行的高度为矩阵宽度的 10%\n            levels: [undefined, {levelSize: &#39;10%&#39;}]\n            // 其他行的高度均匀分配\n            levelSize: undefined,\n            data: [\n                {\n                    // 第一个单元格的宽度为 30 像素\n                    size: 30\n                },\n                // 其他单元格的宽度均匀分配\n                // ...\n            ]\n        },\n        y: {\n            // 第二列的宽度为矩阵宽度的 10%\n            levels: [undefined, {levelSize: &#39;10%&#39;}]\n            // 其他列的宽度均匀分配\n            levelSize: undefined,\n            data: [\n                {\n                    // 第一个单元格的高度为 30 像素\n                    size: 30\n                },\n                // 其他单元格的高度均匀分配\n                // ...\n            ]\n        },\n        // ...\n    },\n}\n</code></pre>\n"
    },
    "x.label": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p>x 轴表头区单元格图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等。</p>\n"
    },
    "x.label.show": {
      "desc": "\n\n<p>是否显示标签。</p>\n",
      "uiControl": {
    ...
    "x.label.rich.shadowColor": {
      "desc": "\n\n<p>文字块的背景阴影颜色。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "x.label.rich.shadowBlur": {
      "desc": "\n\n<p>文字块的背景阴影长度。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "x.label.rich.textBorderColor": {
      "desc": "\n\n<p>文字本身的描边颜色。</p>\n<p>如果设置为 <code class=\"codespan\">&#39;inherit&#39;</code>，则为视觉映射得到的颜色，如系列色。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "x.label.rich.textBorderWidth": {
      "desc": "\n\n<p>文字本身的描边宽度。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "x.label.rich.textBorderDashOffset": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p>用于设置虚线的偏移量，可搭配 \n<code class=\"codespan\">textBorderType</code>\n 指定 dash array 实现灵活的虚线效果。</p>\n<p>更多详情可以参考 MDN <a href=\"https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/lineDashOffset\" target=\"_blank\">lineDashOffset</a>。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "x.label.rich.textShadowOffsetX": {
      "desc": "\n\n<p>文字本身的阴影 X 偏移。</p>\n",
      "uiControl": {
        "type": "number",
        "step": "0.5"
    ...
    "x.label.rich.textShadowOffsetY": {
      "desc": "\n\n<p>文字本身的阴影 Y 偏移。</p>\n",
      "uiControl": {
        "type": "number",
        "step": "0.5"
    ...
    "x.itemStyle.borderColor": {
      "desc": "\n\n<p>x 轴表头区单元格图形的描边颜色。支持的颜色格式同 <code class=\"codespan\">color</code>，不支持回调函数。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "x.itemStyle.borderWidth": {
      "desc": "\n\n<p>x 轴表头区单元格描边线宽。为 0 时无描边。</p>\n",
      "uiControl": {
        "type": "number",
        "value": "1",
        "min": "0",
    ...
    "x.cursor": {
      "desc": "<p>鼠标悬停在单元格上时的鼠标样式。</p>\n"
    },
    "x.z2": {
      "desc": "<p>指定单元格的 z-index（堆叠顺序）。\n用于样式冲突时，尤其是边框较粗时。</p>\n"
    },
    "x.levelSize": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p><strong>[[单元格尺寸的规则]]</strong></p>\n<ul>\n<li>配置项 <code class=\"codespan\">levelSize</code><ul>\n<li>用于指定某一行或某一列所有单元格的尺寸。<ul>\n<li>对于 <code class=\"codespan\">matrix.x</code>，指的是一行单元格的高度（&quot;level&quot; 指一行）。</li>\n<li>对于 <code class=\"codespan\">matrix.y</code>，指的是一列单元格的宽度（&quot;level&quot; 指一列）。</li>\n</ul>\n</li>\n<li>可以在以下位置声明：<ul>\n<li><code class=\"codespan\">matrix.levelSize</code>：指定所有行或列的默认尺寸。</li>\n<li><code class=\"codespan\">matrix.levels[i].levelSize</code>：指定某一行或列的尺寸。</li>\n</ul>\n</li>\n</ul>\n</li>\n<li>配置项 <code class=\"codespan\">size</code><ul>\n<li>用于指定单个单元格的尺寸。<ul>\n<li>对于 <code class=\"codespan\">matrix.x</code>，指的是单元格的宽度。</li>\n<li>对于 <code class=\"codespan\">matrix.y</code>，指的是单元格的高度。</li>\n</ul>\n</li>\n<li>可以在以下位置声明：<ul>\n<li><code class=\"codespan\">matrix.x/y.data[i].size</code></li>\n</ul>\n</li>\n</ul>\n</li>\n</ul>\n<p><code class=\"codespan\">levelSize</code> 或 <code class=\"codespan\">size</code> 的取值可以为：</p>\n<ul>\n<li>未指定（默认）：宽度或高度会被均匀分配。</li>\n<li><code class=\"codespan\">number</code>：表示像素值。</li>\n<li><code class=\"codespan\">string</code>：百分比值（如 <code class=\"codespan\">&#39;33%&#39;</code>），表示相对于矩阵宽度（在 <code class=\"codespan\">matrix.x</code> 中）或高度（在 <code class=\"codespan\">matrix.y</code> 中）的百分比。</li>\n</ul>\n<p>例如：</p>\n<pre><code class=\"lang-js\">{\n    matrix: {\n        x: {\n            // 第二行的高度为矩阵宽度的 10%\n            levels: [undefined, {levelSize: &#39;10%&#39;}]\n            // 其他行的高度均匀分配\n            levelSize: undefined,\n            data: [\n                {\n                    // 第一个单元格的宽度为 30 像素\n                    size: 30\n                },\n                // 其他单元格的宽度均匀分配\n                // ...\n            ]\n        },\n        y: {\n            // 第二列的宽度为矩阵宽度的 10%\n            levels: [undefined, {levelSize: &#39;10%&#39;}]\n            // 其他列的宽度均匀分配\n            levelSize: undefined,\n            data: [\n                {\n                    // 第一个单元格的高度为 30 像素\n                    size: 30\n                },\n                // 其他单元格的高度均匀分配\n                // ...\n            ]\n        },\n        // ...\n    },\n}\n</code></pre>\n"
    },
    "x.levels": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>每一列（对于 <code class=\"codespan\">matrix.x</code>）或每一行（对于 <code class=\"codespan\">matrix.y</code>）的设置。第一个元素表示第一列/行，依此类推。</p>\n<ul>\n<li>如果数组中的某一项为 <code class=\"codespan\">null</code>/<code class=\"codespan\">undefined</code>，表示使用默认值。</li>\n<li>否则每一项应为一个对象，例如 <code class=\"codespan\">{levelSize: number}</code>。</li>\n</ul>\n<p>例如</p>\n<pre><code class=\"lang-js\">matrix: {\n    x: {\n        level: [null, {levelSize: &#39;20%&#39;}]\n        // 第二列宽度应为矩阵宽度的 20%。\n        // 第一列没有特殊设置。\n    },\n    // ...\n},\n</code></pre>\n"
    },
    "x.levels.levelSize": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p><strong>[[单元格尺寸的规则]]</strong></p>\n<ul>\n<li>配置项 <code class=\"codespan\">levelSize</code><ul>\n<li>用于指定某一行或某一列所有单元格的尺寸。<ul>\n<li>对于 <code class=\"codespan\">matrix.x</code>，指的是一行单元格的高度（&quot;level&quot; 指一行）。</li>\n<li>对于 <code class=\"codespan\">matrix.y</code>，指的是一列单元格的宽度（&quot;level&quot; 指一列）。</li>\n</ul>\n</li>\n<li>可以在以下位置声明：<ul>\n<li><code class=\"codespan\">matrix.levelSize</code>：指定所有行或列的默认尺寸。</li>\n<li><code class=\"codespan\">matrix.levels[i].levelSize</code>：指定某一行或列的尺寸。</li>\n</ul>\n</li>\n</ul>\n</li>\n<li>配置项 <code class=\"codespan\">size</code><ul>\n<li>用于指定单个单元格的尺寸。<ul>\n<li>对于 <code class=\"codespan\">matrix.x</code>，指的是单元格的宽度。</li>\n<li>对于 <code class=\"codespan\">matrix.y</code>，指的是单元格的高度。</li>\n</ul>\n</li>\n<li>可以在以下位置声明：<ul>\n<li><code class=\"codespan\">matrix.x/y.data[i].size</code></li>\n</ul>\n</li>\n</ul>\n</li>\n</ul>\n<p><code class=\"codespan\">levelSize</code> 或 <code class=\"codespan\">size</code> 的取值可以为：</p>\n<ul>\n<li>未指定（默认）：宽度或高度会被均匀分配。</li>\n<li><code class=\"codespan\">number</code>：表示像素值。</li>\n<li><code class=\"codespan\">string</code>：百分比值（如 <code class=\"codespan\">&#39;33%&#39;</code>），表示相对于矩阵宽度（在 <code class=\"codespan\">matrix.x</code> 中）或高度（在 <code class=\"codespan\">matrix.y</code> 中）的百分比。</li>\n</ul>\n<p>例如：</p>\n<pre><code class=\"lang-js\">{\n    matrix: {\n        x: {\n            // 第二行的高度为矩阵宽度的 10%\n            levels: [undefined, {levelSize: &#39;10%&#39;}]\n            // 其他行的高度均匀分配\n            levelSize: undefined,\n            data: [\n                {\n                    // 第一个单元格的宽度为 30 像素\n                    size: 30\n                },\n                // 其他单元格的宽度均匀分配\n                // ...\n            ]\n        },\n        y: {\n            // 第二列的宽度为矩阵宽度的 10%\n            levels: [undefined, {levelSize: &#39;10%&#39;}]\n            // 其他列的宽度均匀分配\n            levelSize: undefined,\n            data: [\n                {\n                    // 第一个单元格的高度为 30 像素\n                    size: 30\n                },\n                // 其他单元格的高度均匀分配\n                // ...\n            ]\n        },\n        // ...\n    },\n}\n</code></pre>\n"
    },
    ...
    "y.data": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>指定 y 轴表头区单元格 的数据，即定义列/行。</p>\n<pre><code class=\"lang-js\">// 一行的数据\ndata: [&#39;A&#39;, &#39;B&#39;, &#39;C&#39;, &#39;D&#39;, &#39;E&#39;]\n\n// 或者如果不关心列/行名称，可以直接\ndata: Array(5).fill(null) // 五列或五行\n// 注：不支持未初始化数组项的数组：\n// data: Array(5) // ❌\n\n// 树状结构的数据\ndata: [{\n    value: &#39;A&#39;,\n    children: [\n        {\n            value: &#39;A1&#39;,\n            children: [\n                {value: &#39;A1-1&#39;},\n                {value: &#39;A1-2&#39;}\n            ]\n        },\n        {value: &#39;A2&#39;}\n    ]\n}, {\n    value: &#39;B&#39;,\n    children: [\n        {value: &#39;B1&#39;},\n        {value: &#39;B2&#39;}\n    ]\n}]\n</code></pre>\n<p>如果 <a href=\"#matrix.y.data\">matrix.y.data</a> 没有提供，它会从 <code class=\"codespan\">series.data</code> 或者 <code class=\"codespan\">dataset.source</code> 中自动收集。</p>\n<p>参见 <a href=\"https://echarts.apache.org/examples/zh/editor.html?c=matrix-mini-bar-data-collection&amp;edit=1&amp;reset=1\" target=\"_blank\">示例</a>。</p>\n<p>在这种情况下，<a href=\"#series-scatter.encode\">series.encode</a> 可指定从哪个维度收集数据。例如：</p>\n<pre><code class=\"lang-js\">var option = {\n    // matrix.x/y.data 没有指定。\n    // 于是从 series.data or dataset.source 收集。\n    matrix: {},\n    series: {\n        type: &#39;scatter&#39;,\n        coordinateSystem: &#39;matrix&#39;,\n        // 指定从 dimension index 为 3 和 2 的列收集数据。\n        encode: {x: 3, y: 2},\n        data: [\n            // 0   1    2    3    (dimension index)\n            [100, 111, 122, 133],\n            [200, 211, 222, 233],\n        ]\n    }\n}\n</code></pre>\n"
    },
    "y.data.value": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>每个表头单元格中的文字，也可用于索引这行或列。如果不指定，自动生成一个。</p>\n"
    },
    "y.data.children": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>见 <a href=\"#matrix.y.data\">matrix.y.data</a>.</p>\n"
    },
    "y.data.size": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n<p><strong>[[单元格尺寸的规则]]</strong></p>\n<ul>\n<li>配置项 <code class=\"codespan\">levelSize</code><ul>\n<li>用于指定某一行或某一列所有单元格的尺寸。<ul>\n<li>对于 <code class=\"codespan\">matrix.x</code>，指的是一行单元格的高度（&quot;level&quot; 指一行）。</li>\n<li>对于 <code class=\"codespan\">matrix.y</code>，指的是一列单元格的宽度（&quot;level&quot; 指一列）。</li>\n</ul>\n</li>\n<li>可以在以下位置声明：<ul>\n<li><code class=\"codespan\">matrix.levelSize</code>：指定所有行或列的默认尺寸。</li>\n<li><code class=\"codespan\">matrix.levels[i].levelSize</code>：指定某一行或列的尺寸。</li>\n</ul>\n</li>\n</ul>\n</li>\n<li>配置项 <code class=\"codespan\">size</code><ul>\n<li>用于指定单个单元格的尺寸。<ul>\n<li>对于 <code class=\"codespan\">matrix.x</code>，指的是单元格的宽度。</li>\n<li>对于 <code class=\"codespan\">matrix.y</code>，指的是单元格的高度。</li>\n</ul>\n</li>\n<li>可以在以下位置声明：<ul>\n<li><code class=\"codespan\">matrix.x/y.data[i].size</code></li>\n</ul>\n</li>\n</ul>\n</li>\n</ul>\n<p><code class=\"codespan\">levelSize</code> 或 <code class=\"codespan\">size</code> 的取值可以为：</p>\n<ul>\n<li>未指定（默认）：宽度或高度会被均匀分配。</li>\n<li><code class=\"codespan\">number</code>：表示像素值。</li>\n<li><code class=\"codespan\">string</code>：百分比值（如 <code class=\"codespan\">&#39;33%&#39;</code>），表示相对于矩阵宽度（在 <code class=\"codespan\">matrix.x</code> 中）或高度（在 <code class=\"codespan\">matrix.y</code> 中）的百分比。</li>\n</ul>\n<p>例如：</p>\n<pre><code class=\"lang-js\">{\n    matrix: {\n        x: {\n            // 第二行的高度为矩阵宽度的 10%\n            levels: [undefined, {levelSize: &#39;10%&#39;}]\n            // 其他行的高度均匀分配\n            levelSize: undefined,\n            data: [\n                {\n                    // 第一个单元格的宽度为 30 像素\n                    size: 30\n                },\n                // 其他单元格的宽度均匀分配\n                // ...\n            ]\n        },\n        y: {\n            // 第二列的宽度为矩阵宽度的 10%\n            levels: [undefined, {levelSize: &#39;10%&#39;}]\n            // 其他列的宽度均匀分配\n            levelSize: undefined,\n            data: [\n                {\n                    // 第一个单元格的高度为 30 像素\n                    size: 30\n                },\n                // 其他单元格的高度均匀分配\n                // ...\n            ]\n        },\n        // ...\n    },\n}\n</code></pre>\n"
    },
    "y.label": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p>y 轴表头区单元格图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等。</p>\n"
    },
    "y.label.show": {
      "desc": "\n\n<p>是否显示标签。</p>\n",
      "uiControl": {
    ...
    "y.label.rich.shadowColor": {
      "desc": "\n\n<p>文字块的背景阴影颜色。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "y.label.rich.shadowBlur": {
      "desc": "\n\n<p>文字块的背景阴影长度。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "y.label.rich.textBorderColor": {
      "desc": "\n\n<p>文字本身的描边颜色。</p>\n<p>如果设置为 <code class=\"codespan\">&#39;inherit&#39;</code>，则为视觉映射得到的颜色，如系列色。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "y.label.rich.textBorderWidth": {
      "desc": "\n\n<p>文字本身的描边宽度。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "y.label.rich.textBorderDashOffset": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p>用于设置虚线的偏移量，可搭配 \n<code class=\"codespan\">textBorderType</code>\n 指定 dash array 实现灵活的虚线效果。</p>\n<p>更多详情可以参考 MDN <a href=\"https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/lineDashOffset\" target=\"_blank\">lineDashOffset</a>。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "y.label.rich.textShadowOffsetX": {
      "desc": "\n\n<p>文字本身的阴影 X 偏移。</p>\n",
      "uiControl": {
        "type": "number",
        "step": "0.5"
    ...
    "y.label.rich.textShadowOffsetY": {
      "desc": "\n\n<p>文字本身的阴影 Y 偏移。</p>\n",
      "uiControl": {
        "type": "number",
        "step": "0.5"
    ...
    "y.itemStyle.borderColor": {
      "desc": "\n\n<p>y 轴表头区单元格图形的描边颜色。支持的颜色格式同 <code class=\"codespan\">color</code>，不支持回调函数。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "y.itemStyle.borderWidth": {
      "desc": "\n\n<p>y 轴表头区单元格描边线宽。为 0 时无描边。</p>\n",
      "uiControl": {
        "type": "number",
        "value": "1",
        "min": "0",
    ...
    "body": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>内容区单元格，即表单除了表头区外的区域。</p>\n"
    },
    "body.data": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>为 内容区单元格 指定部分特殊单元格定义。</p>\n<pre><code class=\"lang-js\">data: [\n    {\n        coord: [[3, 5], [1, 2]], // 必填。用于定位单元格。\n                                 // 详细规则见下方描述。\n        value: &#39;some_text&#39;,      // 可选。要显示的文本。\n        mergeCells: true,        // 可选。默认为 `false`。\n    },\n    {\n        // ...\n    },\n    // ...\n]\n</code></pre>\n<p>单元格定位与引用规则详见 <a href=\"#matrix.body.data.coord\">matrix.body.data</a> 的描述。</p>\n"
    },
    "body.data.coord": {
      "desc": "<p><strong>内容区/角区单元格定位说明</strong></p>\n<p>定位规则在 <code class=\"codespan\">matrix.dataToPoint</code>、<code class=\"codespan\">matrix.dataToLayout</code> 及 <code class=\"codespan\">xxxComponent.coord</code> 等 API 中统一适用。</p>\n<p>假设矩阵 x/y 维度（表头）定义如下：</p>\n<pre><code class=\"lang-js\">matrix: {\n    x: [{ value: &#39;Xa0&#39;, children: [&#39;Xb0&#39;, &#39;Xb1&#39;] }, &#39;Xa1&#39;],\n    y: [{ value: &#39;Ya0&#39;, children: [&#39;Yb0&#39;, &#39;Yb1&#39;] }],\n}\n</code></pre>\n<pre><code> -----------------------------------------\n |       |       |     Xa0       |       |\n |-------+-------+---------------|  Xa1  |\n |cornerQ|cornerP|  Xb0  |  Xb1  |       |\n |-------+-------+-------+-------+--------\n |       |  Yb0  | bodyR | bodyS |       |\n |  Ya0  |-------+-------+---------------|\n |       |  Yb1  |       |     bodyT     |\n |---------------|------------------------\n</code></pre><ul>\n<li><strong>Locator number</strong>：<ul>\n<li><code class=\"codespan\">locator</code> 表示用于在 x 或 y 方向定位单元格的整数。</li>\n<li>以内容区左上角单元格为原点 <code class=\"codespan\">(0, 0)</code>，<ul>\n<li>非负数表示原点右侧/下方；</li>\n<li>负数表示原点左侧/上方。</li>\n</ul>\n</li>\n</ul>\n</li>\n<li><strong>Ordinal number</strong>：<ul>\n<li>与笛卡尔坐标系类目轴一致。为非负整数，指定每个 <code class=\"codespan\">matrix.x.data[i].value</code>/<code class=\"codespan\">matrix.y.data[i].value</code>。如 <code class=\"codespan\">&#39;Xb0&#39;</code>、<code class=\"codespan\">&#39;Xb2&#39;</code>、<code class=\"codespan\">&#39;Xa1&#39;</code>、<code class=\"codespan\">&#39;Xa0&#39;</code> 分别对应序数 <code class=\"codespan\">0</code>、<code class=\"codespan\">1</code>、<code class=\"codespan\">2</code>、<code class=\"codespan\">3</code>。每个叶子维度单元格的 <code class=\"codespan\">OrdinalNumber</code> 与 <code class=\"codespan\">MatrixXYLocator</code> 相同。</li>\n</ul>\n</li>\n<li>单个或多个单元格可通过 locator 数字、ordinal 数字或原始 value 字符串数组定位。例如：<ul>\n<li>如上表中的 bodyS 可通过以下方式定位：<ul>\n<li><code class=\"codespan\">coord: [1, 0]</code>（非负整数）</li>\n<li><code class=\"codespan\">coord: [&#39;Xb1&#39;, &#39;Yb0&#39;]</code>（使用 <code class=\"codespan\">matrix.x/y.data</code> 的 value 属性）</li>\n<li><code class=\"codespan\">coord: [&#39;Xb1&#39;, 0]</code>（混合用法）</li>\n</ul>\n</li>\n<li>角区单元格 cornerQ 可通过：<ul>\n<li><code class=\"codespan\">coord: [-2, -1]</code>（负数定位）</li>\n<li>不支持 <code class=\"codespan\">coord: [&#39;Y1_0&#39;, &#39;X1_0&#39;]</code>（XY 交换形式）。</li>\n</ul>\n</li>\n<li>维度（表头）单元格可通过负数定位。例如 <code class=\"codespan\">&#39;Ya0&#39;</code> 的中心可通过 <code class=\"codespan\">[-2, &#39;Ya0&#39;]</code> 定位。</li>\n<li>跨单元格定位：如 <code class=\"codespan\">[[&#39;Xb0&#39;, &#39;Xb1&#39;], [&#39;Yb0&#39;]]</code>，或用非叶子维度单元格如 <code class=\"codespan\">[&#39;Xa0&#39;, &#39;Yb0&#39;]</code>，此时仅返回维度单元格中心（结果可能在两个 body 单元格边界上）。&#39;Xa0&#39; 的序数为 3，因此 <code class=\"codespan\">[3, &#39;Yb0&#39;]</code> 也可定位到同一位置。</li>\n</ul>\n</li>\n<li>简而言之，<code class=\"codespan\">matrix.data.coord</code> 的格式如下：<ul>\n<li><code class=\"codespan\">[2, 8]</code> 表示单个单元格。</li>\n<li><code class=\"codespan\">[[2, 5], 8]</code> 表示 x 方向 2~5，y 方向 8 的矩形区域。</li>\n<li><code class=\"codespan\">[[2, 5], [7, 8]]</code> 表示 x 方向 2~5，y 方向 7~8 的矩形区域。</li>\n<li><code class=\"codespan\">[&#39;aNonLeaf&#39;, 8]</code> 表示 x 方向为非叶子节点，y 方向为 8 的区域。</li>\n<li><code class=\"codespan\">[2, null/undefined/NaN]</code> 表示 y 方向整列（仅在 <code class=\"codespan\">coordClamp: true</code> 时生效）。</li>\n<li><code class=\"codespan\">[null/undefined/NaN, 8]</code> 表示 x 方向整行（仅在 <code class=\"codespan\">coordClamp: true</code> 时生效）。</li>\n<li><code class=\"codespan\">[[2, 5], null/undefined/NaN]</code> 表示 x 方向 2~5，y 方向整列（仅在 <code class=\"codespan\">coordClamp: true</code> 时生效）。</li>\n</ul>\n</li>\n<li><strong>注意</strong><ul>\n<li>上表中的 bodyR 对应 <code class=\"codespan\">[0, 0]</code>。</li>\n<li><code class=\"codespan\">matrix.data.coord</code> 的格式为 <code class=\"codespan\">MatrixCoordRangeOption[]</code>。</li>\n</ul>\n</li>\n<li><code class=\"codespan\">dataToPoint</code> 和 <code class=\"codespan\">dataToLayout</code> API 也遵循此定位规则：<ul>\n<li>输入 <code class=\"codespan\">[&#39;Xa1&#39;, &#39;Yb1&#39;]</code> 到 <code class=\"codespan\">dataToPoint</code> 得到 bodyT 的中心点。</li>\n<li>输入 <code class=\"codespan\">[&#39;Xa1&#39;, &#39;Yb1&#39;]</code> 到 <code class=\"codespan\">dataToLayout</code> 得到 bodyT 的矩形区域。</li>\n</ul>\n</li>\n</ul>\n"
    },
    "body.data.coordClamp": {
      "desc": "<ul>\n<li><code class=\"codespan\">true</code>: <code class=\"codespan\">matrix.body/corner.data[i].coord</code> 中 <code class=\"codespan\">[null/undefined/NaN/invalid_values, xxx]</code> 或 <code class=\"codespan\">[xxx, null/undefined/NaN/invalid_values]</code> 能指代一整行/列.</li>\n<li><code class=\"codespan\">false</code>: 不支持上述设定，且使用这些值时会打印错误提示（仅在 dev 模式下打印）。</li>\n</ul>\n"
    },
    "body.data.mergeCells": {
      "desc": "<p>内容区或角区单元格可���并。</p>\n"
    },
    "body.data.value": {
      "desc": "<p>单元格中显示的文本。</p>\n"
    },
    "body.label": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p>内容区单元格图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等。</p>\n"
    },
    "body.label.show": {
      "desc": "\n\n<p>是否显示标签。</p>\n",
      "uiControl": {
    ...
    "body.label.rich.backgroundColor": {
      "desc": "\n\n<p>文字块背景色。</p>\n<p>可以使用颜色值，例如：<code class=\"codespan\">&#39;#123234&#39;</code>, <code class=\"codespan\">&#39;red&#39;</code>, <code class=\"codespan\">&#39;rgba(0,23,11,0.3)&#39;</code>。</p>\n<p>也可以直接使用图片，例如：</p>\n<pre><code class=\"lang-ts\">backgroundColor: {\n    image: &#39;xxx/xxx.png&#39;\n    // 这里可以是图片的 URL，\n    // 或者图片的 dataURI，\n    // 或者 HTMLImageElement 对象，\n    // 或者 HTMLCanvasElement 对象。\n}\n</code></pre>\n<p>当使用图片的时候，可以使用 <code class=\"codespan\">width</code> 或 <code class=\"codespan\">height</code> 指定高宽，也可以不指定自适应。</p>\n<p>如果设置为 <code class=\"codespan\">&#39;inherit&#39;</code>，则为视觉映射得到的颜色，如系列色。</p>\n",
      "uiControl": {
        "type": "color",
        "default": "#fff"
    ...
    "body.label.rich.borderDashOffset": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p>用于设置虚线的偏移量，可搭配 \n<code class=\"codespan\">borderType</code>\n 指定 dash array 实现灵活的虚线效果。</p>\n<p>更多详情可以参考 MDN <a href=\"https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/lineDashOffset\" target=\"_blank\">lineDashOffset</a>。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "body.label.rich.shadowColor": {
      "desc": "\n\n<p>文字块的背景阴影颜色。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "body.label.rich.shadowBlur": {
      "desc": "\n\n<p>文字块的背景阴影长度。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "body.label.rich.width": {
      "desc": "<p>文字块的宽度。一般不用指定，不指定则自动是文字的宽度。在想做表格项或者使用图片（参见 <code class=\"codespan\">backgroundColor</code>）时，可能会使用它。</p>\n<p>注意，文字块的 <code class=\"codespan\">width</code> 和 <code class=\"codespan\">height</code> 指定的是内容高宽，不包含 <code class=\"codespan\">padding</code>。</p>\n<p><code class=\"codespan\">width</code> 也可以是百分比字符串，如 <code class=\"codespan\">&#39;100%&#39;</code>。表示的是所在文本块的 <code class=\"codespan\">contentWidth</code>（即不包含文本块的 <code class=\"codespan\">padding</code>）的百分之多少。之所以以 <code class=\"codespan\">contentWidth</code> 做基数，因为每个文本片段只能基于 <code class=\"codespan\">content box</code> 布局。如果以 <code class=\"codespan\">outerWidth</code> 做基数，则百分比的计算在实用中不具有意义，可能会超出。</p>\n<p>注意，如果不定义 <code class=\"codespan\">rich</code> 属性，则不能指定 <code class=\"codespan\">width</code> 和 <code class=\"codespan\">height</code>。</p>\n"
    },
    "body.label.rich.height": {
      "desc": "<p>文字块的高度。一般不用指定，不指定则自动是文字的高度。在使用图片（参见 <code class=\"codespan\">backgroundColor</code>）时，可能会使用它。</p>\n<p>注意，文字块的 <code class=\"codespan\">width</code> 和 <code class=\"codespan\">height</code> 指定的是内容高宽，不包含 <code class=\"codespan\">padding</code>。</p>\n<p>注意，如果不定义 <code class=\"codespan\">rich</code> 属性，则不能指定 <code class=\"codespan\">width</code> 和 <code class=\"codespan\">height</code>。</p>\n"
    },
    "body.label.rich.textBorderColor": {
      "desc": "\n\n<p>文字本身的描边颜色。</p>\n<p>如果设置为 <code class=\"codespan\">&#39;inherit&#39;</code>，则为视觉映射得到的颜色，如系列色。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "body.label.rich.textBorderWidth": {
      "desc": "\n\n<p>文字本身的描边宽度。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "body.label.rich.textBorderType": {
      "desc": "\n\n\n<p>文字本身的描边类型。</p>\n<p>可选：</p>\n<ul>\n<li><code class=\"codespan\">&#39;solid&#39;</code></li>\n<li><code class=\"codespan\">&#39;dashed&#39;</code></li>\n<li><code class=\"codespan\">&#39;dotted&#39;</code></li>\n</ul>\n<p>自 <code class=\"codespan\">v5.0.0</code> 开始，也可以是 <code class=\"codespan\">number</code> 或者 <code class=\"codespan\">number</code> 数组，用以指定线条的 <a href=\"https://developer.mozilla.org/zh-CN/docs/Web/SVG/Attribute/stroke-dasharray\" target=\"_blank\">dash array</a>，配合 \n<code class=\"codespan\">textBorderDashOffset</code>\n 可实现更灵活的虚线效果。</p>\n<p>例如：</p>\n<pre><code class=\"lang-ts\">{\n\ntextBorderType: [5, 10],\n\ntextBorderDashOffset: 5\n}\n</code></pre>\n",
      "uiControl": {
        "type": "enum",
        "default": "solid",
    ...
    "body.label.rich.textBorderDashOffset": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p>用于设置虚线的偏移量，可搭配 \n<code class=\"codespan\">textBorderType</code>\n 指定 dash array 实现灵活的虚线效果。</p>\n<p>更多详情可以参考 MDN <a href=\"https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/lineDashOffset\" target=\"_blank\">lineDashOffset</a>。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "body.label.rich.textShadowColor": {
      "desc": "\n\n<p>文字本身的阴影颜色。</p>\n",
      "uiControl": {
        "type": "color",
        "default": "#000"
    ...
    "body.label.rich.textShadowBlur": {
      "desc": "\n\n<p>文字本身的阴影长度。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "body.label.rich.textShadowOffsetX": {
      "desc": "\n\n<p>文字本身的阴影 X 偏移。</p>\n",
      "uiControl": {
        "type": "number",
        "step": "0.5"
    ...
    "body.label.rich.textShadowOffsetY": {
      "desc": "\n\n<p>文字本身的阴影 Y 偏移。</p>\n",
      "uiControl": {
        "type": "number",
        "step": "0.5"
    ...
    "body.itemStyle.borderColor": {
      "desc": "\n\n<p>内容区单元格图形的描边颜色。支持的颜色格式同 <code class=\"codespan\">color</code>，不支持回调函数。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "body.itemStyle.borderWidth": {
      "desc": "\n\n<p>内容区单元格描边线宽。为 0 时无描边。</p>\n",
      "uiControl": {
        "type": "number",
        "value": "1",
        "min": "0",
    ...
    "corner": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>角区单元格，即表单行列表头区的交集区域。</p>\n"
    },
    "corner.data": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>为 角区单元格 指定部分特殊单元格定义。</p>\n<pre><code class=\"lang-js\">data: [\n    {\n        coord: [[3, 5], [1, 2]], // 必填。用于定位单元格。\n                                 // 详细规则见下方描述。\n        value: &#39;some_text&#39;,      // 可选。要显示的文本。\n        mergeCells: true,        // 可选。默认为 `false`。\n    },\n    {\n        // ...\n    },\n    // ...\n]\n</code></pre>\n<p>单元格定位与引用规则详见 <a href=\"#matrix.body.data.coord\">matrix.body.data</a> 的描述。</p>\n"
    },
    "corner.data.coord": {
      "desc": "<p><strong>内容区/角区单元格定位说明</strong></p>\n<p>定位规则在 <code class=\"codespan\">matrix.dataToPoint</code>、<code class=\"codespan\">matrix.dataToLayout</code> 及 <code class=\"codespan\">xxxComponent.coord</code> 等 API 中统一适用。</p>\n<p>假设矩阵 x/y 维度（表头）定义如下：</p>\n<pre><code class=\"lang-js\">matrix: {\n    x: [{ value: &#39;Xa0&#39;, children: [&#39;Xb0&#39;, &#39;Xb1&#39;] }, &#39;Xa1&#39;],\n    y: [{ value: &#39;Ya0&#39;, children: [&#39;Yb0&#39;, &#39;Yb1&#39;] }],\n}\n</code></pre>\n<pre><code> -----------------------------------------\n |       |       |     Xa0       |       |\n |-------+-------+---------------|  Xa1  |\n |cornerQ|cornerP|  Xb0  |  Xb1  |       |\n |-------+-------+-------+-------+--------\n |       |  Yb0  | bodyR | bodyS |       |\n |  Ya0  |-------+-------+---------------|\n |       |  Yb1  |       |     bodyT     |\n |---------------|------------------------\n</code></pre><ul>\n<li><strong>Locator number</strong>：<ul>\n<li><code class=\"codespan\">locator</code> 表示用于在 x 或 y 方向定位单元格的整数。</li>\n<li>以内容区左上角单元格为原点 <code class=\"codespan\">(0, 0)</code>，<ul>\n<li>非负数表示原点右侧/下方；</li>\n<li>负数表示原点左侧/上方。</li>\n</ul>\n</li>\n</ul>\n</li>\n<li><strong>Ordinal number</strong>：<ul>\n<li>与笛卡尔坐标系类目轴一致。为非负整数，指定每个 <code class=\"codespan\">matrix.x.data[i].value</code>/<code class=\"codespan\">matrix.y.data[i].value</code>。如 <code class=\"codespan\">&#39;Xb0&#39;</code>、<code class=\"codespan\">&#39;Xb2&#39;</code>、<code class=\"codespan\">&#39;Xa1&#39;</code>、<code class=\"codespan\">&#39;Xa0&#39;</code> 分别对应序数 <code class=\"codespan\">0</code>、<code class=\"codespan\">1</code>、<code class=\"codespan\">2</code>、<code class=\"codespan\">3</code>。每个叶子维度单元格的 <code class=\"codespan\">OrdinalNumber</code> 与 <code class=\"codespan\">MatrixXYLocator</code> 相同。</li>\n</ul>\n</li>\n<li>单个或多个单元格可通过 locator 数字、ordinal 数字或原始 value 字符串数组定位。例如：<ul>\n<li>如上表中的 bodyS 可通过以下方式定位：<ul>\n<li><code class=\"codespan\">coord: [1, 0]</code>（非负整数）</li>\n<li><code class=\"codespan\">coord: [&#39;Xb1&#39;, &#39;Yb0&#39;]</code>（使用 <code class=\"codespan\">matrix.x/y.data</code> 的 value 属性）</li>\n<li><code class=\"codespan\">coord: [&#39;Xb1&#39;, 0]</code>（混合用法）</li>\n</ul>\n</li>\n<li>角区单元格 cornerQ 可通过：<ul>\n<li><code class=\"codespan\">coord: [-2, -1]</code>（负数定位）</li>\n<li>不支持 <code class=\"codespan\">coord: [&#39;Y1_0&#39;, &#39;X1_0&#39;]</code>（XY 交换形式）。</li>\n</ul>\n</li>\n<li>维度（表头）单元格可通过负数定位。例如 <code class=\"codespan\">&#39;Ya0&#39;</code> 的中心可通过 <code class=\"codespan\">[-2, &#39;Ya0&#39;]</code> 定位。</li>\n<li>跨单元格定位：如 <code class=\"codespan\">[[&#39;Xb0&#39;, &#39;Xb1&#39;], [&#39;Yb0&#39;]]</code>，或用非叶子维度单元格如 <code class=\"codespan\">[&#39;Xa0&#39;, &#39;Yb0&#39;]</code>，此时仅返回维度单元格中心（结果可能在两个 body 单元格边界上）。&#39;Xa0&#39; 的序数为 3，因此 <code class=\"codespan\">[3, &#39;Yb0&#39;]</code> 也可定位到同一位置。</li>\n</ul>\n</li>\n<li>简而言之，<code class=\"codespan\">matrix.data.coord</code> 的格式如下：<ul>\n<li><code class=\"codespan\">[2, 8]</code> 表示单个单元格。</li>\n<li><code class=\"codespan\">[[2, 5], 8]</code> 表示 x 方向 2~5，y 方向 8 的矩形区域。</li>\n<li><code class=\"codespan\">[[2, 5], [7, 8]]</code> 表示 x 方向 2~5，y 方向 7~8 的矩形区域。</li>\n<li><code class=\"codespan\">[&#39;aNonLeaf&#39;, 8]</code> 表示 x 方向为非叶子节点，y 方向为 8 的区域。</li>\n<li><code class=\"codespan\">[2, null/undefined/NaN]</code> 表示 y 方向整列（仅在 <code class=\"codespan\">coordClamp: true</code> 时生效）。</li>\n<li><code class=\"codespan\">[null/undefined/NaN, 8]</code> 表示 x 方向整行（仅在 <code class=\"codespan\">coordClamp: true</code> 时生效）。</li>\n<li><code class=\"codespan\">[[2, 5], null/undefined/NaN]</code> 表示 x 方向 2~5，y 方向整列（仅在 <code class=\"codespan\">coordClamp: true</code> 时生效）。</li>\n</ul>\n</li>\n<li><strong>注意</strong><ul>\n<li>上表中的 bodyR 对应 <code class=\"codespan\">[0, 0]</code>。</li>\n<li><code class=\"codespan\">matrix.data.coord</code> 的格式为 <code class=\"codespan\">MatrixCoordRangeOption[]</code>。</li>\n</ul>\n</li>\n<li><code class=\"codespan\">dataToPoint</code> 和 <code class=\"codespan\">dataToLayout</code> API 也遵循此定位规则：<ul>\n<li>输入 <code class=\"codespan\">[&#39;Xa1&#39;, &#39;Yb1&#39;]</code> 到 <code class=\"codespan\">dataToPoint</code> 得到 bodyT 的中心点。</li>\n<li>输入 <code class=\"codespan\">[&#39;Xa1&#39;, &#39;Yb1&#39;]</code> 到 <code class=\"codespan\">dataToLayout</code> 得到 bodyT 的矩形区域。</li>\n</ul>\n</li>\n</ul>\n"
    },
    ...
    "corner.data.mergeCells": {
      "desc": "<p>内容区或角区单元格可合并。</p>\n"
    },
    "corner.data.value": {
      "desc": "<p>单元格中显示的文本。</p>\n"
    },
    "corner.label": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p>角区单元格图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等。</p>\n"
    },
    "corner.label.show": {
      "desc": "\n\n<p>是否显示标签。</p>\n",
      "uiControl": {
    ...
    "corner.label.rich.verticalAlign": {
      "desc": "\n\n<p>文字垂直对齐方式，默认自动。</p>\n<p>可选：</p>\n<ul>\n<li><code class=\"codespan\">&#39;top&#39;</code></li>\n<li><code class=\"codespan\">&#39;middle&#39;</code></li>\n<li><code class=\"codespan\">&#39;bottom&#39;</code></li>\n</ul>\n<p><code class=\"codespan\">rich</code> 中如果没有设置 <code class=\"codespan\">verticalAlign</code>，则会取父层级的 <code class=\"codespan\">verticalAlign</code>。例如：</p>\n<pre><code class=\"lang-ts\">{\n    verticalAlign: bottom,\n    rich: {\n        a: {\n            // 没有设置 `verticalAlign`，则 `verticalAlign` 为 bottom\n        }\n    }\n}\n</code></pre>\n",
      "uiControl": {
        "type": "enum",
        "options": "top,middle,bottom"
    ...
    "corner.label.rich.backgroundColor": {
      "desc": "\n\n<p>文字块背景色。</p>\n<p>可以使用颜色值，例如：<code class=\"codespan\">&#39;#123234&#39;</code>, <code class=\"codespan\">&#39;red&#39;</code>, <code class=\"codespan\">&#39;rgba(0,23,11,0.3)&#39;</code>。</p>\n<p>也可以直接使用图片，例如：</p>\n<pre><code class=\"lang-ts\">backgroundColor: {\n    image: &#39;xxx/xxx.png&#39;\n    // 这里可以是图片的 URL，\n    // 或者图片的 dataURI，\n    // 或者 HTMLImageElement 对象，\n    // 或者 HTMLCanvasElement 对象。\n}\n</code></pre>\n<p>当使用图片的时候，可以使用 <code class=\"codespan\">width</code> 或 <code class=\"codespan\">height</code> 指定高宽，也可以不指定自适应。</p>\n<p>如果设置为 <code class=\"codespan\">&#39;inherit&#39;</code>，则为视觉映射得到的颜色，如系列色。</p>\n",
      "uiControl": {
        "type": "color",
        "default": "#fff"
    ...
    "corner.label.rich.borderDashOffset": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p>用于设置虚线的偏移量，可搭配 \n<code class=\"codespan\">borderType</code>\n 指定 dash array 实现灵活的虚线效果。</p>\n<p>更多详情可以参考 MDN <a href=\"https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/lineDashOffset\" target=\"_blank\">lineDashOffset</a>。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "corner.label.rich.borderRadius": {
      "desc": "\n\n<p>文字块的圆角。</p>\n",
      "uiControl": {
        "type": "vector",
        "min": "0",
    ...
    "corner.label.rich.shadowColor": {
      "desc": "\n\n<p>文字块的背景阴影颜色。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "corner.label.rich.shadowBlur": {
      "desc": "\n\n<p>文字块的背景阴影长度。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "corner.label.rich.shadowOffsetX": {
      "desc": "\n\n<p>文字块的背景阴影 X 偏移。</p>\n",
      "uiControl": {
        "type": "number",
        "step": "0.5"
    ...
    "corner.label.rich.shadowOffsetY": {
      "desc": "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n",
      "uiControl": {
        "type": "number",
        "step": "0.5"
    ...
    "corner.label.rich.width": {
      "desc": "<p>文字块的宽度。一般不用指定，不指定则自动是文字的宽度。在想做表格项或者使用图片（参见 <code class=\"codespan\">backgroundColor</code>）时，可能会使用它。</p>\n<p>注意，文字块的 <code class=\"codespan\">width</code> 和 <code class=\"codespan\">height</code> 指定的是内容高宽，不包含 <code class=\"codespan\">padding</code>。</p>\n<p><code class=\"codespan\">width</code> 也可以是百分比字符串，如 <code class=\"codespan\">&#39;100%&#39;</code>。表示的是所在文本块的 <code class=\"codespan\">contentWidth</code>（即不包含文本块的 <code class=\"codespan\">padding</code>）的百分之多少。之所以以 <code class=\"codespan\">contentWidth</code> 做基数，因为每个文本片段只能基于 <code class=\"codespan\">content box</code> 布局。如果以 <code class=\"codespan\">outerWidth</code> 做基数，则百分比的计算在实用中不具有意义，可能会超出。</p>\n<p>注意，如果不定义 <code class=\"codespan\">rich</code> 属性，则不能指定 <code class=\"codespan\">width</code> 和 <code class=\"codespan\">height</code>。</p>\n"
    },
    "corner.label.rich.height": {
      "desc": "<p>文字块的高度。一般不用指定，不指定则自动是文字的高度。在使用图片（参见 <code class=\"codespan\">backgroundColor</code>）时，可能会使用它。</p>\n<p>注意，文字块的 <code class=\"codespan\">width</code> 和 <code class=\"codespan\">height</code> 指定的是内容高宽，不包含 <code class=\"codespan\">padding</code>。</p>\n<p>注意，如果不定义 <code class=\"codespan\">rich</code> 属性，则不能指定 <code class=\"codespan\">width</code> 和 <code class=\"codespan\">height</code>。</p>\n"
    },
    "corner.label.rich.textBorderColor": {
      "desc": "\n\n<p>文字本身的描边颜色。</p>\n<p>如果设置为 <code class=\"codespan\">&#39;inherit&#39;</code>，则为视觉映射得到的颜色，如系列色。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "corner.label.rich.textBorderWidth": {
      "desc": "\n\n<p>文字本身的描边宽度。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "corner.label.rich.textBorderType": {
      "desc": "\n\n\n<p>文字本身的描边类型。</p>\n<p>可选：</p>\n<ul>\n<li><code class=\"codespan\">&#39;solid&#39;</code></li>\n<li><code class=\"codespan\">&#39;dashed&#39;</code></li>\n<li><code class=\"codespan\">&#39;dotted&#39;</code></li>\n</ul>\n<p>自 <code class=\"codespan\">v5.0.0</code> 开始，也可以是 <code class=\"codespan\">number</code> 或者 <code class=\"codespan\">number</code> 数组，用以指定线条的 <a href=\"https://developer.mozilla.org/zh-CN/docs/Web/SVG/Attribute/stroke-dasharray\" target=\"_blank\">dash array</a>，配合 \n<code class=\"codespan\">textBorderDashOffset</code>\n 可实现更灵活的虚线效果。</p>\n<p>例如：</p>\n<pre><code class=\"lang-ts\">{\n\ntextBorderType: [5, 10],\n\ntextBorderDashOffset: 5\n}\n</code></pre>\n",
      "uiControl": {
        "type": "enum",
        "default": "solid",
    ...
    "corner.label.rich.textBorderDashOffset": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v5.0.0</code> 开始支持\n\n</div>\n\n\n\n\n\n<p>用于设置虚线的偏移量，可搭配 \n<code class=\"codespan\">textBorderType</code>\n 指定 dash array 实现灵活的虚线效果。</p>\n<p>更多详情可以参考 MDN <a href=\"https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/lineDashOffset\" target=\"_blank\">lineDashOffset</a>。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "corner.label.rich.textShadowColor": {
      "desc": "\n\n<p>文字本身的阴影颜色。</p>\n",
      "uiControl": {
        "type": "color",
        "default": "#000"
    ...
    "corner.label.rich.textShadowBlur": {
      "desc": "\n\n<p>文字本身的阴影长度。</p>\n",
      "uiControl": {
        "type": "number",
        "min": "0",
    ...
    "corner.label.rich.textShadowOffsetX": {
      "desc": "\n\n<p>文字本身的阴影 X 偏移。</p>\n",
      "uiControl": {
        "type": "number",
        "step": "0.5"
    ...
    "corner.label.rich.textShadowOffsetY": {
      "desc": "\n\n<p>文字本身的阴影 Y 偏移。</p>\n",
      "uiControl": {
        "type": "number",
        "step": "0.5"
    ...
    "corner.itemStyle.borderColor": {
      "desc": "\n\n<p>角区单元格图形的描边颜色。支持的颜色格式同 <code class=\"codespan\">color</code>，不支持回调函数。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "corner.itemStyle.borderWidth": {
      "desc": "\n\n<p>角区单元格描边线宽。为 0 时无描边。</p>\n",
      "uiControl": {
        "type": "number",
        "value": "1",
        "min": "0",
    ...
    "backgroundStyle.borderColor": {
      "desc": "\n\n<p>整个矩形视图区图形的描边颜色。支持的颜色格式同 <code class=\"codespan\">color</code>，不支持回调函数。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "backgroundStyle.borderWidth": {
      "desc": "\n\n<p>整个矩形视图区描边线宽。为 0 时无描边。</p>\n",
      "uiControl": {
        "type": "number",
        "value": "1",
        "min": "0",
    ...
    "borderZ2": {
      "desc": "<p>最外层的边框和分割线的 z2-index 。</p>\n"
    },
    "tooltip": {
      "desc": "<p>单元格的 tooltip 配置，配置项同 <a href=\"#tooltip\">tooltip</a>。默认不显示，文字很多的时候会被裁剪，这时可以开启 tooltip，如下示例：</p>\n<pre><code class=\"lang-ts\">matrix: {\n    tooltip: {\n        show: true\n    },\n    // ...\n}\n</code></pre>\n"
    }
  },
  "__ROOT__": "matrix",
  "__UTILS__": 3
