{
  "__EC_DOC_option_tooltip": {
    ...
    "displayTransition": {
      "desc": "\n\n\n\n<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>提示框显示/隐藏时是否启用过渡动画。</p>\n<p>默认情况下，提示框通过透明度淡入淡出过渡效果来实现显示/隐藏，而不是直接将 DOM 元素的 <code class=\"codespan\">display</code> 属性设置为 <code class=\"codespan\">&#39;none&#39;</code>。这在提示框内容比较多出现滚动条时，可能导致提示框隐藏后滚动条仍然存在的问题。在这种情况下，或者如果只是不想使用淡入淡出效果，可以将此选项设置为 <code class=\"codespan\">false</code> 以禁用显示/隐藏过渡动画。</p>\n",
      "uiControl": {
        "type": "boolean",
        "default": "true"
      }
