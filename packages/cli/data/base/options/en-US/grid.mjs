export default {
  "__EC_DOC_option_grid": {
    ...
    "outerBoundsMode": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>外边界（outer bounds）是一个用于限制轴标签和轴名称溢出的矩形区域。<code class=\"codespan\">outerBoundsMode</code> 用于定义如何确定该“外边界”的策略。</p>\n<p>在大多数情况下，无需显式指定 <a href=\"#grid.outerBoundsMode\">grid.outerBoundsMode</a>、<a href=\"#grid.outerBounds\">grid.outerBounds</a>、<a href=\"#grid.outerBoundsContain\">grid.outerBoundsContain</a> 和 <a href=\"#grid.containLabel\">grid.containLabel</a>，因为默认配置已经能够有效防止轴标签和轴名称溢出画布。</p>\n<p>直角坐标系组件（grid）的布局策略如下：</p>\n<ul>\n<li>首先，根据 <a href=\"#grid.left\">grid.left</a>/<a href=\"#grid.right\">right</a>/<a href=\"#grid.top\">top</a>/<a href=\"#grid.bottom\">bottom</a>/<a href=\"#grid.width\">width</a>/<a href=\"#grid.height\">height</a> 所定义的矩形区域布置轴线。这可以满足多个 grid 对齐轴线的需求。</li>\n<li>然后，如果轴标签或轴名称超出了外边界（outer bounds），则会收缩该矩形区域以避免溢出。其中，<a href=\"#grid.outerBoundsContain\">grid.outerBoundsContain</a> 可决定轴标签和轴名称是否受外边界的限制。</li>\n</ul>\n<p><code class=\"codespan\">outerBoundsMode</code> 的可选值有：</p>\n<ul>\n<li><code class=\"codespan\">&#39;auto&#39;</code>/<code class=\"codespan\">null</code>/<code class=\"codespan\">undefined</code>（默认值）：<ul>\n<li>当 <code class=\"codespan\">grid.containLabel: true</code> 时，行为等同于 <code class=\"codespan\">outerBoundsMode: &#39;same&#39;</code>。</li>\n<li>否则，如果设置了 <a href=\"#grid.outerBounds\">grid.outerBounds</a>，则使用该值作为外边界（outer bounds）。</li>\n<li>否则，自动确定外边界（outer bounds）—— 通常默认为当前 canvas 区域；或者，假如该 grid 被布局在其他坐标系中时（参见 <a href=\"#grid.coordinateSystem\">grid.coordinateSystem</a>），使用其他坐标系提指定的布局矩形作为外边界。</li>\n</ul>\n</li>\n<li><code class=\"codespan\">&#39;none&#39;</code>：强制将外边界（outer bounds）设为无限大（即不作任何限制），无视是否设置了 <a href=\"#grid.outerBounds\">grid.outerBounds</a>。</li>\n<li>&#39;same&#39;：强制将外边界（outer bounds）设置为由 <a href=\"#grid.left\">grid.left</a>/<a href=\"#grid.right\">right</a>/<a href=\"#grid.top\">top</a>/<a href=\"#grid.bottom\">bottom</a>/<a href=\"#grid.width\">width</a>/<a href=\"#grid.height\">height</a> 所定义的矩形，无视是否设置了 <a href=\"#grid.outerBounds\">grid.outerBounds</a>。</li>\n</ul>\n<blockquote>\n<p>外边界（outer bounds）已涵盖 <a href=\"#grid.containLabel\">grid.containLabel</a> 的功能，因此 <a href=\"#grid.containLabel\">grid.containLabel</a> 被不再推荐使用（deprecated）。\n<code class=\"codespan\">grid.containLabel: true</code> 等价于 <code class=\"codespan\">grid: {outerBoundsMode: &#39;same&#39;, outerBoundsContain: &#39;axisLabel&#39;}</code>。效果上可能会有细微差别，但通常难以察觉。你可以使用以下代码来强制保持原有效果，不过一般并无此必要。</p>\n<pre><code class=\"lang-js\">import {use} from &#39;echarts/core&#39;;\nimport {LegacyGridContainLabel} from &#39;echarts/features&#39;;\nuse([LegacyGridContainLabel]);\n</code></pre>\n</blockquote>\n<p><strong>示例</strong>: <a href=\"https://echarts.apache.org/examples/zh/editor.html?c=doc-example/grid-outerBounds&amp;edit=1&amp;reset=1\" target=\"_blank\">outerBounds 示例</a>.</p>\n"
    },
    "outerBounds": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>详见 <a href=\"#grid.outerBoundsMode\">grid.outerBoundsMode</a>.</p>\n<p>也参见 <a href=\"https://echarts.apache.org/examples/zh/editor.html?c=doc-example/grid-outerBounds&amp;edit=1&amp;reset=1\" target=\"_blank\">outerBounds 示例</a>.</p>\n"
    },
    "outerBounds.left": {
      "desc": "\n\n\n\n\n<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n<p>外边界（<code class=\"codespan\">outerBounds</code>）离容器左侧的距离。</p>\n<p><code class=\"codespan\">left</code> 的值可以是像 <code class=\"codespan\">20</code> 这样的具体像素值，可以是像 <code class=\"codespan\">&#39;20%&#39;</code> 这样相对于容器宽度的百分比，也可以是 <code class=\"codespan\">&#39;left&#39;</code>, <code class=\"codespan\">&#39;center&#39;</code>, <code class=\"codespan\">&#39;right&#39;</code>。</p>\n<p>如果 <code class=\"codespan\">left</code> 的值为 <code class=\"codespan\">&#39;left&#39;</code>, <code class=\"codespan\">&#39;center&#39;</code>, <code class=\"codespan\">&#39;right&#39;</code>，组件会根据相应的位置自动对齐。</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "outerBounds.top": {
      "desc": "\n\n\n\n\n<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n<p>外边界（<code class=\"codespan\">outerBounds</code>）离容器上侧的距离。</p>\n<p><code class=\"codespan\">top</code> 的值可以是像 <code class=\"codespan\">20</code> 这样的具体像素值，可以是像 <code class=\"codespan\">&#39;20%&#39;</code> 这样相对于容器高度的百分比，也可以是 <code class=\"codespan\">&#39;top&#39;</code>, <code class=\"codespan\">&#39;middle&#39;</code>, <code class=\"codespan\">&#39;bottom&#39;</code>。</p>\n<p>如果 <code class=\"codespan\">top</code> 的值为 <code class=\"codespan\">&#39;top&#39;</code>, <code class=\"codespan\">&#39;middle&#39;</code>, <code class=\"codespan\">&#39;bottom&#39;</code>，组件会根据相应的位置自动对齐。</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "outerBounds.right": {
      "desc": "\n\n\n\n\n<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n<p>外边界（<code class=\"codespan\">outerBounds</code>）离容器右侧的距离。</p>\n<p><code class=\"codespan\">right</code> 的值可以是像 <code class=\"codespan\">20</code> 这样的具体像素值，可以是像 <code class=\"codespan\">&#39;20%&#39;</code> 这样相对于容器宽度的百分比。</p>\n<p>默认自适应。</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "outerBounds.bottom": {
      "desc": "\n\n\n\n\n<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n<p>外边界（<code class=\"codespan\">outerBounds</code>）离容器下侧的距离。</p>\n<p>bottom 的值可以是像 <code class=\"codespan\">20</code> 这样的具体像素值，可以是像 <code class=\"codespan\">&#39;20%&#39;</code> 这样相对于容器高度的百分比。</p>\n<p>默认自适应。</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "0%"
      }
    ...
    "outerBounds.width": {
      "desc": "\n\n\n\n\n<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n<p>外边界（<code class=\"codespan\">outerBounds</code>）的宽度。默认自适应。</p>\n<p><code class=\"codespan\">width</code> 的值可以是像 <code class=\"codespan\">20</code> 这样的具体像素值，可以是像 <code class=\"codespan\">&#39;20%&#39;</code> 这样相对于容器宽度的百分比。</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "50%"
      }
    ...
    "outerBounds.height": {
      "desc": "\n\n\n\n\n<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n\n<p>外边界（<code class=\"codespan\">outerBounds</code>）的高度。默认自适应。</p>\n<p><code class=\"codespan\">height</code> 的值可以是像 <code class=\"codespan\">20</code> 这样的具体像素值，可以是像 <code class=\"codespan\">&#39;20%&#39;</code> 这样相对于容器高度的百分比。</p>\n",
      "uiControl": {
        "type": "percent",
        "default": "50%"
      }
    ...
    "outerBoundsContain": {
      "desc": "<div  class=\"doc-partial-version\">\n\n从 <code  class=\"codespan\">v6.0.0</code> 开始支持\n\n</div>\n\n\n\n<p>可选值：</p>\n<ul>\n<li><code class=\"codespan\">&#39;auto&#39;</code>/<code class=\"codespan\">null</code>/<code class=\"codespan\">undefined</code>（默认）：<ul>\n<li>若设置了 <code class=\"codespan\">containLabel: true</code>，行为等同于 <code class=\"codespan\">outerBoundsContain: &#39;axisLabel&#39;</code>。</li>\n<li>否则，行为等同于 <code class=\"codespan\">outerBoundsContain: &#39;all&#39;</code>。</li>\n</ul>\n</li>\n<li><code class=\"codespan\">&#39;all&#39;</code>：外边界（outer bounds）会限制直角坐标系（grid）由 x 轴线和 y 轴线决定的矩形区域、轴标签（axis label）和轴名称（axis name）。</li>\n<li><code class=\"codespan\">&#39;axisLabel&#39;</code>：外边界（outer bounds）会限制直角坐标系（grid）由 x 轴线和 y 轴线决定矩形区域和轴标签（axis label）；不会限制轴名称（axis name）。</li>\n</ul>\n<p>更多信息参见 <a href=\"#grid.outerBoundsMode\">grid.outerBoundsMode</a>.</p>\n<p>也参见 <a href=\"https://echarts.apache.org/examples/zh/editor.html?c=doc-example/grid-outerBounds&amp;edit=1&amp;reset=1\" target=\"_blank\">outerBounds 示例</a>.</p>\n"
    },
    "backgroundColor": {
      "desc": "\n\n<p>直角坐标系（grid）背景色，默认透明。</p>\n<blockquote>\n<p>颜色可以使用 RGB 表示，比如 <code class=\"codespan\">&#39;rgb(128, 128, 128)&#39;</code>   ，如果想要加上 alpha 通道，可以使用 RGBA，比如 <code class=\"codespan\">&#39;rgba(128, 128, 128, 0.5)&#39;</code>，也可以使用十六进制格式，比如 <code class=\"codespan\">&#39;#ccc&#39;</code></p>\n</blockquote>\n<p><strong>注意</strong>：此配置项生效的前提是，设置了 <code class=\"codespan\">show: true</code>。</p>\n",
      "uiControl": {
        "type": "color"
      }
    },
    "borderColor": {
      "desc": "\n\n<p>直角坐标系（grid）的边框颜色。支持的颜色格式同 backgroundColor。</p>\n<p><strong>注意</strong>：此配置项生效的前提是，设置了 <code class=\"codespan\">show: true</code>。</p>\n",
      "uiControl": {
        "type": "color",
        "default": "#ccc"
      }
