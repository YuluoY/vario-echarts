export default {
  "__EC_DOC_option_dataZoom_slider": {
    "id": {
    ...
    "handleStyle": {
      "desc": "<p>Style of handle. Please refer to <a href=\"https://echarts.apache.org/examples/en/editor.html?c=area-simple\" target=\"_blank\">area-simple example</a>.</p>\n"
    },
    "handleStyle.color": {
      "desc": "\n\n<p> color. </p>\n<blockquote>\n<p>Supports setting as solid color using <code class=\"codespan\">rgb(255,255,255)</code>, <code class=\"codespan\">rgba(255,255,255,1)</code>, <code class=\"codespan\">#fff</code>, etc. Also supports setting as gradient color and pattern fill, see <a href=\"#color\">option.color</a> for details</p>\n</blockquote>\n",
      "uiControl": {
    ...
    "handleLabel": {
      "desc": "<div  class=\"doc-partial-version\">\n\nSince <code  class=\"codespan\">v5.6.0</code>\n\n</div>\n\n\n\n\n<p>Style settings for the text near the handle.</p>\n"
    },
    "handleLabel.show": {
    ...
    "zoomLock": {
      "desc": "\n\n<p>Specify whether to lock the size of window (selected area).</p>\n<p>When set as <code class=\"codespan\">true</code>, the size of window is locked, that is, only the translation (by mouse drag or touch drag) is available but zoom is not.</p>\n",
      "uiControl": {
        "type": "boolean"
      }
    },
    ...
    "width": {
      "desc": "\n\n<p>Width of dataZoom-slider component. Default to 30 when vertical, adaptive when horizontal.</p>\n<p>Has higher priority than <code class=\"codespan\">left</code> and <code class=\"codespan\">right</code>.</p>\n",
      "uiControl": {
        "type": "number",
        "default": "30"
      }
    ...
    "height": {
      "desc": "\n\n<p>Height of dataZoom-slider component. Default to 30 when horizontal, adaptive when vertical.</p>\n<p>Has higher priority than <code class=\"codespan\">top</code> and <code class=\"codespan\">bottom</code>.</p>\n",
      "uiControl": {
        "type": "number",
        "default": "30"
      }
