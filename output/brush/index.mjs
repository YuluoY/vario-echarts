export default [
  {
    ...
    "children": [
      ...
      },
      {
        ...
        "_raw": {
          "label": "Z",
          "desc": "<p>brush 选框的 z-index。当有和不相关组件有不正确的重叠时，可以进行调整。</p>\n"
        }
      }
    ]
  }
