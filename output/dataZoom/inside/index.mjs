export default [
  {
    ...
    "children": [
      ...
      },
      {
        ...
        "model": "dataZoom.inside.xAxisIndex",
        "props": {
          "placeholder": "x轴索引",
          "types": [
            "number",
      ...
      {
        "type": "SmartUnionInput",
        "model": "dataZoom.inside.yAxisIndex",
        "props": {
          "placeholder": "Y轴索引",
          "types": [
            "number",
      ...
      {
        "type": "SmartUnionInput",
        "model": "dataZoom.inside.radiusAxisIndex",
        "props": {
          "placeholder": "半径轴索引",
          "types": [
            "number",
      ...
      {
        "type": "SmartUnionInput",
        "model": "dataZoom.inside.angleAxisIndex",
        "props": {
          "placeholder": "角度轴索引",
          "types": [
            "number",
      ...
      },
      {
        "type": "ElInput",
        "model": {
          "path": "dataZoom.inside.filterMode",
          "default": "filter"
        },
        "props": {
          "placeholder": "筛选模式"
      ...
      {
        "type": "SmartUnionInput",
        "model": "dataZoom.inside.startValue",
        "props": {
          "placeholder": "起始值",
          "types": [
            "number",
      ...
      {
        "type": "SmartUnionInput",
        "model": "dataZoom.inside.endValue",
        "props": {
          "placeholder": "结束数值",
          "types": [
            "number",
      ...
      {
        "type": "SmartUnionInput",
        "model": "dataZoom.inside.minValueSpan",
        "props": {
          "placeholder": "最小数值跨度",
          "types": [
            "number",
      ...
      {
        "type": "SmartUnionInput",
        "model": "dataZoom.inside.maxValueSpan",
        "props": {
          "placeholder": "最大数值跨度",
          "types": [
            "number",
      ...
      {
        "type": "ElInput",
        "model": "dataZoom.inside.rangeMode",
        "props": {
          "placeholder": "范围模式"
        },
        "_raw": {
      ...
      },
      {
        "type": "SmartUnionInput",
        "model": {
          "path": "dataZoom.inside.zoomOnMouseWheel",
          "default": true
        },
        "props": {
          "placeholder": "滚轮缩放",
      ...
      },
      {
        "type": "SmartUnionInput",
        "model": {
          "path": "dataZoom.inside.moveOnMouseMove",
          "default": true
        },
        "props": {
          "placeholder": "鼠标移动平移",
      ...
      },
      {
        "type": "SmartUnionInput",
        "model": {
          "path": "dataZoom.inside.moveOnMouseWheel",
          "default": true
        },
        "props": {
          "placeholder": "滚轮平移",
      ...
      },
      {
        "type": "ElSwitch",
        "model": {
          "path": "dataZoom.inside.preventDefaultMouseMove",
          "default": true
        },
        "props": {
          "placeholder": "阻止默认鼠标移动"
        },
        "_raw": {
          "label": "阻止默认鼠标移动",
