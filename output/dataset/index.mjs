export default [
  {
    ...
    "children": [
      ...
      },
      {
        ...
        "_raw": {
          "label": "转换",
          "desc": "<p>参见 <a href=\"https://echarts.apache.org/handbook/zh/concepts/data-transform\" target=\"_blank\">数据变换教程</a></p>\n"
        }
      },
      {
        "type": "ElInputNumber",
        "model": "dataset.fromDatasetIndex",
        "props": {
          "placeholder": "来源数据集索引"
        },
        "_raw": {
      ...
      {
        "type": "ElInputNumber",
        "model": "dataset.fromTransformResult",
        "props": {
          "placeholder": "来源转换结果"
        },
        "_raw": {
